...
public class PaymentBalance {
    ...
    /**
     * Represents the not set balance amount.
     */
    private double notSetBalance;
     ...
     * Get not set balance.
     *
     * @return not set balance
     */
    public double getNotSetBalance() {
        return notSetBalance;
    }

    /**
     * Set not set balance.
     *
     * @param notSetBalance not set balance
     */
    public void setNotSetBalance(double notSetBalance) {
        this.notSetBalance = notSetBalance;
    }
}
