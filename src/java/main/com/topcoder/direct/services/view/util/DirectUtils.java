 ...
 * <ol>
 * <li>Added
 * {@link #getStudioContestSubmissions(long, ContestRoundType, TCSubject, ContestServiceFacade)}
 * method.</li>
 * </ol>
 * </p>
 *
 ...
 * <li>Update
 * {@link #getStudioContestSubmissions(long, ContestRoundType, TCSubject, ContestServiceFacade)}
 * method to use getCheckpointSubmissionsForContest and
 * getFinalSubmissionsForContest methods to retrieve submissions.</li>
 * <li>Add {@link #getContestPrizeNumber(SoftwareCompetition, ContestRoundType)}
 * method to get the number of a contest's prizes.</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <ul>
 * <li>Added {@link #getSubmissionsCheckout(List, ContestRoundType)} method to
 * check whether submissions have already been checked out.</li>
 * <li>Added {@link #getAdditionalPrize(StudioCompetition)} method to get the
 * additional prize.</li>
 * </ul>
 * </p>
 *
 ...
 * <ol>
 * <li>Updated {@link #getContestStats(TCSubject, long, boolean)} method to
 * calculate stats for <code>Copilot
 ...
 * </ul>
 * These methods are refactored from EnterpriseDashboardAction,
 * DashboardCostReportAction and DashboardBillingCostReport action for
 * increasing the reuse.
 * </p>
 * <p>
 * Version 1.6.5 (TC Cockpit Bug Tracking R1 Contest Tracking assembly) change
 * notes:
 * <ul>
 * <li>Change method getContestStats to add the number of jira issues and bug
 * races of the contest into contest statistics</li>
 * </ul>
 * </p>
 * <p>
 * Version 1.6.6 (TC Cockpit Bug Tracking R1 Cockpit Project Tracking assembly)
 * change notes:
 * <ul>
 * <li>Change method getContestStats to add contest issues into contest
 * stats</li>
 * </ul>
 * </p>
 * <p>
 * Version 1.6.7 (System Assembly - Direct TopCoder Scorecard Tool Integration)
 * change notes:
 * <ul>
 ...
 *
 * <p>
 * Version 1.6.8 (Release Assembly - TC Cockpit Enterprise Dashboard Update
 * Assembly 1) change notes:
 * <ul>
 ...
 *
 * <p>
 * Version 1.6.9 (Release Assembly - Direct Improvements Assembly Release 3)
 * change notes:
 * <ul>
 * <li>Added
 * {@link #setSoftwareCompetitionDirectProjectName(com.topcoder.service.project.SoftwareCompetition, java.util.List)}
 * method</li>
 * <li>Added
 * {@link #setStudioCompetitionDirectProjectName(com.topcoder.service.project.StudioCompetition, java.util.List)}</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <ol>
 * <li>Update {@link #getContestStats(TCSubject, long, boolean)} method to work
 * with the new Studio contest type.</li>
 ...
 * <ol>
 * <li>Add {@link #CHECKPOINT_PRIZE_TYPE_ID} and {@link #CONTEST_PRIZE_TYPE_ID}
 * constants.</li>
 * <li>Add {@link #isPhaseScheduled(SoftwareCompetition, PhaseType)}
 * method.</li>
 * <li>Update
 * {@link #getStudioContestSubmissions(long, ContestRoundType, TCSubject, ContestServiceFacade)}
 * and {@link #getContestPrizeNumber(SoftwareCompetition, ContestRoundType)}
 * methods to work with the new studio contest type.</li>
 * <li>Add {@link #getContestCheckout(SoftwareCompetition, ContestRoundType)}
 * method.</li>
 * <li>Add
 * {@link #getStudioSubmissionsFeedback(TCSubject, ContestServiceFacade, List, long, PhaseType)}
 * method.</li>
 * </ol>
 * </p>
 *
 ...
 * <li>Fixed
 * {@link #getStudioContestSubmissions(long, ContestRoundType, TCSubject, ContestServiceFacade)}
 * method to work for Final Round.</li>
 * </ol>
 * </p>
 *
 * <p>
 ...
 * <ol>
 * <li>Update {@link #getContestStats} method to use the new
 * direct_contest_stats_replatforming query.</li>
 * </ol>
 * </p>
 *
 *
 ...
 * <ol>
 * <li>Updated <code>setDashboardData</code> methods to properly analyze the
 * types of the contest.</li>
 * </ol>
 * </p>
 *
 * <p>
 * Version 1.7.5 (Release Assembly - TopCoder Cockpit Project Status Management)
 * Change notes:
 * <ol>
 * <li>Updated <code>setDashboardData</code> methods to properly analyze the
 * types of the contest.</li>
 ...
 *
 * <p>
 * Version 1.7.6 (TopCoder Cockpit Project Overview R1 Project Forum Backend
 * Assembly 1.0) Change notes:
 * <ol>
 * <li>Added
 ...
 * <ol>
 * <li>Added {@link #getInvoiceType(String, List)} to get invoice type by the
 * name of invoice type.</li>
 * <li>Added {@link #canPerformInvoiceRecords(TCSubject)} method.</li>
 * </ol>
 * </p>
 *
 * <p>
 * Version 1.7.8 (Release Assembly - Project Contest Fee Management ) Change
 * notes:
 * <ol>
 * <li>Added {@link #isTCAccounting(TCSubject)} to check the user is TC
 * Accounting or not.</li>
 * <li>Added {@link #isSuperAdmin(TCSubject)} to check the user is TC Admin or
 * not.</li>
 * </ol>
 * </p>
 *
 * <p>
 * Version 1.7.9 (Release Assembly - Project Contest Fee Management Update 1
 * Assembly 1.0) Change notes:
 * <ol>
 * <li>Re-imported contes fee classes from new package
 * com.topcoder.clients.model.</li>
 * </ol>
 * </p>
 *
 * <p>
 * Version 1.8.0 (Release Assembly - TopCoder Cockpit Studio Submission Viewer
 * Revamp v1.0) Change notes:
 * <ol>
 * <li>Added {@link #getStudioSubmissionArtifacts(long)} to fetch image file
 * names.</li>
 * </ol>
 * </p>
 *
 * <p>
 * Version 1.8.1 (Module Assembly - TopCoder Cockpit Project Dashboard Edit
 * Project version 1.0) Change notes:
 * <ol>
 * <li>Added
 * {@link #getClientIdForProject(com.topcoder.security.TCSubject, long)} to
 * fetch the client id of the direct project.</li>
 * </ol>
 * </p>
 *
 * <p>
 * Version 1.8.2 (Release Assembly - TC Cockpit Create Project Refactoring
 * Assembly Part One) Change notes:
 * <ol>
 * <li>change call of contest service facade #getPermissionsByProject to
 * permission service facade #getPermissionsByProject</li>
 * </ol>
 * </p>
 *
 * <p>
 ...
 * <ol>
 * <li>Update
 * {@link #getContestStats(com.topcoder.security.TCSubject, long)}</li> to add
 * checkpoint submission number, final submission number and is multiple round
 * flag.
 * </ol>
 * </p>
 *
 * <p>
 * Version 1.8.4 (Module Assembly - Adding Contest Approval Feature in Direct
 * Assembly 1.0) Change notes:
 * <ol>
 * <li>Added
 * {@link #hasReview(ProjectServices, SoftwareCompetition, long, long, long)}
 * method.</li>
 * <li>Added {@link #getUserResourceByRole(long, SoftwareCompetition, long)}
 * method.</li>
 * </ol>
 * </p>
 *
 ...
 * 
 * <p>
 * Version 1.8.5 (Release Assembly - TC Direct Issue Tracking Tab Update
 * Assembly 2 v1.0) change notes:
 * <ol>
 * <li>Added constant {@link #FINAL_FIX_UPLOAD_TYPE_ID}.</li>
 * <li>Added method {@link #getLastClosedFinalFixPhase(ProjectServices, long)}
 * to get the last closed final fix phase of a project.</li>
 * <li>Added method
 * {@link #addAttachmentsToIssue(String, SessionFileStore, String[])} to upload
 * attachments to a JIRA issue.</li>
 * <li>Added method {@link #addFinalFixToIssue(String, Upload, String)} to
 * upload final fix to a JIRA issue.</li>
 * <li>Added method {@link #getFinalFixUpload(long, long, ContestServiceFacade)}
 * to get the final fix upload of a specified final fix phase.</li>
 * </ol>
 * </p>
 * 
 * <p>
 * Version 1.8.6 (Release Assembly - TopCoder Cockpit Software Checkpoint
 * Management) Change notes:
 * <ol>
 * <li>Updated {@link #getContestStats(TCSubject, long, SoftwareCompetition)}
 * method to add parameter softwareCompetition.</li>
 * </ol>
 * </p>
 *
 * Version 1.8.7 (Module Assembly - TC Cockpit Project Contests Batch Edit)
 * change notes:
 * <ol>
 * <li>Add method
 * {@link #getCurrentProjectBrief(com.topcoder.service.facade.project.ProjectServiceFacade, long)}</li>
 * </ol>
 * </p>
 *
 * <p>
 * Version 1.8.8 (Release Assembly - TC Direct Cockpit Release Five) change
 * notes:
 * <li>Fix getContestCheckout(SoftwareCompetition competition, ContestRoundType
 * roundType), it should check whether the checkpoint review/review phase is
 * closed.</li>
 * </p>
 * <p>
 * Version 1.8.9 (Release Assembly - TopCoder Cockpit Project Overview
 * Performance Improvement)
 * <ol>
 * <li>Add method
 * {@link #createProjectBriefDTOFromProjectData(com.topcoder.service.project.ProjectData)}</li>
 * </ol>
 * </p>
 * <p>
 * Version 1.9.0 (Release Assembly - TC Direct Cockpit Release Seven version
 * 1.0)
 * <p>
 * <li>Updated method
 * {@link #hasReview(com.topcoder.project.service.ProjectServices, com.topcoder.service.project.SoftwareCompetition, long, long, long)}</li>
 * <li>Added method
 * {@link #hasReview(com.topcoder.project.service.ProjectServices, com.topcoder.service.project.SoftwareCompetition, long, long, long, java.util.List)}</li>
 * </p>
 * </p>
 *
 * <p>
 ...
 * <ul>
 * <li>Update getDashboardClientBillingProjectMappings to use the new method to
 * retrieve the client, billing, project mappings. The new method gets the
 * mappings from direct_project_account table</li>
 * </ul>
 * </p>
 *
 * <p>
 * Version 1.9.2 (Cockpit Customer Copilot Posting Process Revamp Copilot
 * Posting Dashboard)
 * <p>
 * <li>Added method
 * {@link #setCopilotDashboardSpecificData(com.topcoder.project.service.ProjectServices, long, com.topcoder.direct.services.view.dto.contest.ContestDashboardDTO)}</li>
 * </p>
 * </p>
 *
 * <p>
 * Version 1.9.3 (Topcoder Security Groups Backend - Direct Permissions
 * Propagation Assembly 1.0) Change notes:
 * <ol>
 * <li>Added
 * {@link #hasPermissionBySecurityGroups(TCSubject, long, AuthorizationService, GroupPermissionType...)}
 * method.</li>
 * <li>Updated
 * {@link #hasWritePermission(BaseDirectStrutsAction, TCSubject, long, boolean)},
 * {@link #hasProjectReadPermission(BaseDirectStrutsAction, TCSubject, long)},
 * {@link #hasProjectWritePermission(BaseDirectStrutsAction, TCSubject, long)}
 * methods to check user permissions against security groups in case all other
 * checks have returned <code>false</code>.</li>
 * <li>Fixed bug in
 * {@link #hasProjectReadPermission(BaseDirectStrutsAction, TCSubject, long)},
 * {@link #hasProjectWritePermission(BaseDirectStrutsAction, TCSubject, long)}
 * methods</li>
 ...
 *
 * <p>
 * Version 1.9.4 (Release Assembly - TopCoder Security Groups - Release 2)
 * Change notes:
 * <ol>
 ...
 * <ul>
 * <li>Add method
 * {@link #isCheckpointSubmissionPhaseClosed(com.topcoder.service.project.SoftwareCompetition)}</li>
 * </ul>
 * </p>
 * 
 * <p>
 * Version 1.9.6 (Release Assembly - TopCoder Cockpit - Launch Contest Update
 * for Marathon Match)
 * <ul>
 * <li>Add method
 * {@link #isMM(com.topcoder.service.project.SoftwareCompetition)}</li>
 * </ul>
 * </p>
 *
 * <p>
 * Version 1.9.7 (Release Assembly - TC Cockpit New Enterprise Dashboard Release
 * 2)
 * <ul>
 ...
 *
 * <p>
 * Version 1.9.6 (TC-Studio - Wireframe Viewer Modal Window Direct integration
 * assembly v1.0)
 * <ul>
 ...
 * 
 * <p>
 * Version 1.9.7 (TC-Studio - Wireframe Viewer Modal Window Direct Updates
 * assembly v1.0)
 * <ul>
 * <li>Update method
 * {@link #getContestStats(TCSubject, long, SoftwareCompetition)} to set the
 * contest type id.</li>
 * <li>Update method {@link #storeZipStream(InputStream, String)} to always set
 * the first directory name to be lower case.</li>
 * </ul>
 * </p>
 *
 * <p>
 * Version 1.9.9 (Release Assembly - TopCoder Cockpit Asset View And Basic
 * Upload version 1.0)
 * <ul>
 ...
 * <li>Added method
 * {@link #updateDirectProjectBugContestFee(TCSubject, long, ProjectServiceFacade, ProjectContestFeeService, ProjectContestFeePercentageService)}
 * to update the fixed bug race contest fee and percentage bug race contest fee
 * for TC direct project based on the contest fee settings of the corresponding
 * billing account.</li>
 * <li>Added method
 * {@link #updateBillingAccountDirectProjectsBugContestFees(TCSubject, long, ProjectServiceFacade, ProjectContestFeeService, ProjectContestFeePercentageService, DirectProjectService)}
 * to update the fixed bug race contest fee and percentage bug race contest fee
 * for all TC direct projects associated with the billing account.</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <li>Added method {@link #isTCPlatformSpecialist(TCSubject)} to check if the
 * user is a TC Platform Specialist..</li>
 * </ul>
 * </p>
 *
 * <p>
 * Version 1.10.2 (Module Assembly - TC Cockpit - Studio - Final Fixes
 ...
 * <li>Added {@link #registerUserToContest(long, long, long, String)}
 * (SoftwareCompetition)} method.</li>
 * <li>Updated {@link #getContestStats(TCSubject, long, SoftwareCompetition)}
 * method to check if for Studio contest the Final Fix tab is to be shown on the
 * page or not.</li>
 * <li>Updated
 * {@link #getStudioContestSubmissions(long, ContestRoundType, TCSubject, ContestServiceFacade)}
 * and {@link #getContestCheckout(SoftwareCompetition, ContestRoundType)}
 * methods to support new <code>Studio Final Fix
 *     </code> round type.</li>
 * </ol>
 * </p>
 *
 ...
 *
 * <p>
 * Version 1.10.4 (Release Assembly - TopCoder Cockpit Asset View Release 4 -
 * Resource restriction update)
 * <ul>
 ...
 * <ul>
 * <li>Added method
 * {@link #appendStringToFilesInZip(com.topcoder.servlet.request.UploadedFile, String)}</li>
 * </ul>
 * </p>
 * <p>
 ...
 * <ol>
 * <li>Add method {@link #setRoundId(Long, Long, Long)} and
 * {@link #updateRoundId(Long, Long, Long)}. They are used to set/update round
 * id for contest.</li>
 * </ol>
 * </p>
 * <p>
 ...
 * <ul>
 * <li>Updated {@link #getContestStats} to return the active VM numbers of the
 * contest</li>
 * <li>Added {@link #isVMManager(com.topcoder.security.TCSubject)} to return if
 * the given user is in VMManager role</li>
 * <li>Added {@link #getCloudVMService()} to get CloudVMService</li>
 * </ul>
 * </p>
 *
 * <p>
 * Version 1.11 (Release Assembly - TC Cockpit New Challenge types Integration
 * Bug Fixes)
 * <ul>
 * <li>Added method
 * {@link #isReviewPhaseClosed(com.topcoder.service.project.SoftwareCompetition)}</li>
 ...
 * <ul>
 * <li>Updated method
 * {@link #getContestStats(com.topcoder.security.TCSubject, long, com.topcoder.service.project.SoftwareCompetition)}
 * to include the forum type data for the contest</li>
 * </ul>
 * </p>
 *
 * <p>
 * Version 1.3 (TopCoder Direct - Update jira issues retrieval to Ajax) @author
 * -jacob- @challenge 30044583
 * <ul>
 * <li>Updated
 * {@link #getContestStats(com.topcoder.security.TCSubject, long, com.topcoder.service.project.SoftwareCompetition)}</li>
 * to remove getting issues data
 * </ul>
 * </p>
 *
 * <p>
 * Version 1.4 (topcoder Direct Refactor Jira RPC and VM Count Retrieval to
 ...
 *         <li>Update method
 *         {@link #getContestStats(com.topcoder.security.TCSubject, long, com.topcoder.service.project.SoftwareCompetition)}
 *         ()} to remove codes which get contest VM count data.</li>
 *         </ul>
 *         </p>
 *
 *         <p>
 ...
 *         <ul>
 *         <li>Added
 *         {@link #getCookieFromRequest(javax.servlet.http.HttpServletRequest, String)}</li>
 *         </ul>
 *         </p>
 *
 *         <p>
 ...
 *
 *         <p>
 *         Version 1.6 (TopCoder Direct - Add Estimation Cost Details to Receipt
 *         page)
 *         <ul>
 *         <li>Added
 *         {@link #getChallengeCostData(com.topcoder.service.project.SoftwareCompetition)}</li>
 *         </ul>
 *         </p>
 *
 *         <p>
 ...
 *         <ul>
 *         <li>Added
 *         {@link #addDirectCookie(javax.servlet.http.HttpServletResponse, String, String, int)}</li>
 *         </ul>
 *         </p>
 *
 *         <p>
 *         Version 1.8 (TOPCODER DIRECT - ASP INTEGRATION WORK MANAGEMENT
 *         IMPROVEMENT) Change notes:
 *         <ol>
 *         <li>Added {@link #insertSubmissionPushStatus(long, long)}
 *         method.</li>
 *         <li>Added {@link #updateSubmissionPushStatus(long, long, String)}
 *         method.</li>
 ...
 *
 *         <p>
 *         Version 1.8.1 (TOPCODER DIRECT - IMPROVEMENT FOR PRE-REGISTER MEMBERS
 *         WHEN LAUNCHING CHALLENGES):
 *         <ol>
 *         <li>Added {@link #getUsersFromHandle(String[])} method</li>
 *         <li>Added {@link #getUnAgreedProjectTermByUser(long, long, Long[])}
 *         methos</li>
 *         </ol>
 *         </p>
 *         <p>
 *         Changes in version 1.9 (TopCoder Direct - Remove ASP Integration
 *         Related Logic):
 *         <ul>
 *         <li>Remove {@link #insertSubmissionPushStatus(long, long)}
 *         method.</li>
 *         <li>Remove {@link #updateSubmissionPushStatus(long, long, String)}
 *         method.</li>
 ...
 *
 *         <p>
 *         Version 2.0 (Topcoder - Ability To Set End Date For Registration
 ...
 *
 *         <p>
 *         Version 2.1 (TOPCODER - IMPROVE TASK ASSIGNEE FILTERING FOR
 ...
 * 
 *         <p>
 *         Version 2.2 - Topcoder - Remove JIRA Issues Related Functionality In
 *         Direct App v1.0 - remove JIRA related functionality
 *         </p>
 *
 *         <p>
 *         Version 2.3 (Topcoder - Implement Registrants tab For Marathon Match
 *         Challenges In Direct App)
 *         <ul>
 ...
 *         <li>Added
 *         {@link #getMMRegistantsSubmissionInfo(List, Long, Long)}</li>
 *         </ul>
 *         </p>
 * 
 *         <p>
 *         Version 2.4 - Quick72Hrs!! Topcoder - Remove VM Management Feature In
 *         Direct App version 1.0 - remove VM related functionality
 *         </p>
 *
 *         <p>
 *         Version 2.5 - Topcoder - Change Download URL in Direct Application -
 *         Add {@link #s3Client} - Add {@link #getS3Client()} to get S3 client
 *         instance - Add {@link #getS3FileKey(String)} to get S3 key from url
 *         </p>
 *
 ...
 *         Ghost_141, jiajizhou86, TCSCODER
 * @version 2.6
 */
public final class DirectUtils {
  ...
  /**
   * <p>
   * A <code>String</code> providing the format for the date of resource's
   * registration to project.
   * </p>
   */
  ...
  /**
   * The project name to use when the direct project name is not available,
  ...
  /**
   * <p>
   * An <code>int</code> referencing the <code>Studio Final Fix</code> submission
   * type.
   * </p>
   *
   * @since 1.10.2
   ...
   * @since 1.10.7
   */
  private static final String SET_ROUND_ID_SQL = "INSERT INTO 'informix'.project_info(project_id, project_info_type_id, value, create_user, create_date, "
   ...
   * @since 1.10.7
   */
  private static final String UPDATE_ROUND_ID_SQL = "UPDATE project_info SET value = ?, modify_user = ?, modify_date = CURRENT WHERE project_id = ? AND "
  ...
  private static final String QUERY_PROJECT_TERMS = "SELECT tou.terms_of_use_id, sort_order, tou.terms_of_use_type_id, "
      ...
      + "AND resource_role_id = ? AND " + "tou.terms_of_use_agreeability_type_id <> 1 order by sort_order";
  ...
  /**
   * The jackson object mapping which is used to deserialize json return from API
   * to domain model.
   */
   ...
   *
   * @param dateString the date string. see <code>DATE_FORMAT</code> for the
   *                   format.
  ...
  /**
   * Sets the errorPageMessage with the specified error message so it can be
   ...
   *
   * <p>
   * version 1.6.5 changes: - add the total number of jira issues and bug races
   * into contest statistics.
   *
   * version 1.6.6 changes: - add issues of the contest into contest stats.
   *
   * version 1.8.5 changes: - add parameter softwareCompetition.
   * </p>
   *
   * <p>
   * Version 1.10.8 changes: - add stats for VM Instances of the contest
   * </p>
   *
   * @param currentUser         a <code>TCSubject</code> representing the current
   *                            user.
   * @param contestId           a <code>long</code> providing the ID of a contest.
   * @param softwareCompetition the contest providing additional information,
   *                            might be null
   * @return a <code>ContestStatsDTO</code> providing the statistics for specified
   *         contest.
   * @throws Exception if an unexpected error occurs while accessing the
   *                   persistent data store.
   * @since 1.1
   */
  public static ContestStatsDTO getContestStats(TCSubject currentUser, long contestId,
      SoftwareCompetition softwareCompetition) throws Exception {
     ...
     * DataProvider.searchUserContests(currentUser, null, null, null); for
     * (DashboardContestSearchResultDTO c : contests) { if (c.getContest().getId()
     * == contestId) { phasedContest.setStatus(c.getStatus()); break; } }
     */
    ...
    if (softwareCompetition != null) {
      dto.setInCheckpointSubmissionOrCheckpointReview(
          isPhaseOpen(softwareCompetition, PhaseType.CHECKPOINT_SUBMISSION_PHASE)
              || isPhaseOpen(softwareCompetition, PhaseType.CHECKPOINT_REVIEW_PHASE));
    }
   ...
   * @throws DatatypeConfigurationException if fail to create the
  ...
  /**
   * <p>
   * Checks whether a <code>SoftwareCompetition</code> is multi round or not.
   * </p>
   *
  ...
  /**
   * <p>
   * Gets the checkpoint submission phase end date for a multiround contest.
   *
  ...
  /**
   * <p>
   * Gets the submission phase end date for a contest.
   *
  ...
  public static Date getRegistrationStartDate(SoftwareCompetition softwareCompetition) {
    ...
    for (Phase phase : softwareCompetition.getProjectPhases().getPhases()) {
      if (phase.getPhaseType().getId() == PhaseType.REGISTRATION_PHASE.getId()) {
        return phase.getActualStartDate() != null ? phase.getActualStartDate() : phase.getScheduledStartDate();
      }
    }
    return null;
  }
  ...
  /**
   * <p>
   * Gets the registration phase end date for a contest.
   *
   * @param softwareCompetition the contest
  ...
  /**
   * <p>
   * Gets the submission phase of the competition.
   *
   * @param softwareCompetition the contest
  ...
  public static Date getEndDate(SoftwareCompetition softwareCompetition) {
    ...
    Date endDate = null;
    for (Phase phase : softwareCompetition.getProjectPhases().getPhases()) {
      Date phaseEnd = (phase.getActualEndDate() != null) ? phase.getActualEndDate() : phase.getScheduledEndDate();
  ...
  /**
   * <p>
   * Determines if any of the phase (ignore spec review/submission) is open or
   * not.
   * </p>
   *
   * @param softwareCompetition the software competition
   ...
   * @return true if the phase of the specified contest is in open status, false
   *         otherwise.
   * @since 1.7.1
   */
   ...
   * @param softwareCompetition the specified contest
   * @param phaseType           the phase
   * @return true if the phase of the specified contest is in scheduled status,
   *         false otherwise.
   * @since 1.7.1
   */
  public static boolean isPhaseScheduled(SoftwareCompetition softwareCompetition, PhaseType phaseType) {
    ...
    for (Phase phase : softwareCompetition.getProjectPhases().getPhases()) {
      if (phase.getPhaseType().getId() == phaseType.getId()
          && phase.getPhaseStatus().getId() == PhaseStatus.SCHEDULED.getId()) {
        return true;
      }
    }
    return false;
  ...
  /**
   * <p>
   * Checks if specified contest has a phase of specified type.
   * </p>
   *
   * @param softwareCompetition the specified contest.
  ...
  /**
   * Checks whether a contest has review (including iterative review) phases all
   * closed.
   *
  ...
  public static List<ProjectPhaseDTO> sortContestPhases(List<ProjectPhaseDTO> phases) {
    ...
    for (ProjectPhaseDTO p : specPart) {
      System.out.println("start date:" + p.getStartTime() + " phase name:" + p.getPhaseType().getShortName()
          + " phase order:" + p.getPhaseType().getOrder());
    }
  ...
  /**
   * <p>
   * Gets the submissions for specified round of specified <code>Studio</code>
   * contest.
   * </p>
   *
   * @param projectId            represents the contest.
   * @param roundType            a <code>ContestRoundType</code> providing the
   *                             type of the contest round.
   * @param currentUser          a <code>TCSubject</code> representing the current
   *                             user.
   * @param contestServiceFacade a <code>ContestServiceFacade</code> to be used
   *                             for accessing the service layer for data
   *                             retrieval.
   * @return a <code>List</code> listing the submissions for specified round of
   *         specified <code>Studio</code> contest.
  ...
  public static List<Submission> getStudioContestSubmissions(long projectId, ContestRoundType roundType,
      TCSubject currentUser, ContestServiceFacade contestServiceFacade)
      throws UploadPersistenceException, SearchBuilderException {
    return Arrays.asList(contestServiceFacade.getSoftwareActiveSubmissions(projectId, roundType.getSubmissionTypeId()));
  }

  /**
   * <p>
   * Gets the number of prizes for specified round of specified
   * <code>Studio</code> contest.
   * </p>
   *
   * @param competition a <code>StudioCompetition</code> providing the studio
   *                    contest.
   * @param roundType   a <code>ContestRoundType</code> providing the type of the
   *                    contest round.
   * @return an <code>int</code> providing the number of the prize for specified
   *         round of specified <code>Studio</code> contest.
   * @since 1.5
   */
   ...
   * @since 1.6.7
   */
  public static void setSoftwareCompetitionDirectProjectName(SoftwareCompetition softwareCompetition,
      List<ProjectData> projects) {
    softwareCompetition.getProjectHeader().setTcDirectProjectName(
        getDirectProjectName(softwareCompetition.getProjectHeader().getTcDirectProjectId(), projects));
  }
  ...
  /**
   * Checks whether a specified round type of a contest is checked out. If the
   * corresponding phase is closed, then the contest is checked out.
   *
   * @param competition the contest to check
   * @param roundType   the specified round type
   * @return true if the specified round type of the contest is checked out, false
   *         otherwise.
   * @since 1.7.1
   */
  ...
  /**
   * Checks whether the checkpoint submission phase is closed for a multiple round
   * software contest.
   *
   * @param competition the software contest to check
   * @return whether the checkpoint submission phase is closed for a multiple
   *         round software contest.
   *
   * @since 1.9.5
   */
  ...
  /**
   * <p>
   * Checks whether a <code>SoftwareCompetition</code> is a studio contest or not.
   * </p>
   *
  ...
  /**
   * <p>
   * Checks whether a <code>SoftwareCompetition</code> is a marathon match contest
   * or not.
   * </p>
   *
   * @param competition the <code>SoftwareCompetition</code> to check
  ...
  public static boolean hasWritePermission(BaseDirectStrutsAction action, TCSubject tcSubject, long contestId,
      boolean isStudio) throws PermissionServiceException, ContestServiceException {
   ...
   * @param contestServiceFacade the <code>ContestServiceFacade</code> service
   *                             bean
   ...
   * @since 1.7.1
   */
  public static Map<Long, String> getStudioSubmissionsFeedback(TCSubject currentUser,
      ContestServiceFacade contestServiceFacade, List<Submission> submissions, long projectId, PhaseType phaseType)
      throws Exception {
   ...
   *
   * <p>
   * Update in version 1.9.1: - use getDashboardClientBillingProjectMappingsV2 to
   * get mappings
   * </p>
   *
  ...
  /**
   * Gets the global client-billing-project mapping cache. If cache is not hit,
  ...
  private static Map<String, Object> getGlobalClientBillingProjectMappingsCache() throws Exception {
    if (DirectUtils.getApplicationContext().get(DirectUtils.PROJECT_BILLING_MAPPING_RESULT_CACHE) == null) {
      DataProvider.fillGlobalClientBillingProjectCache();
    }

    return (Map<String, Object>) DirectUtils.getApplicationContext()
        .get(DirectUtils.PROJECT_BILLING_MAPPING_RESULT_CACHE);
  }
  ...
  public static Map<Long, String> getBillingsForClient(TCSubject tcSubject, long clientId) throws Exception {
    Map<Long, Map<Long, String>> data = (Map<Long, Map<Long, String>>) getDashboardClientBillingProjectMappings(
        tcSubject).get("client.billing");
  ...
  public static Long getClientIdForProject(TCSubject tcSubject, long directProjectId) throws Exception {
    Map<Long, Long> projectClientMap = (Map<Long, Long>) getDashboardClientBillingProjectMappings(tcSubject)
        .get("project.client");
  ...
  public static Map<Long, String> getAllClients(TCSubject tcSubject) throws Exception {
    Map<Long, String> result = sortByValue(
        (Map<Long, String>) getDashboardClientBillingProjectMappings(tcSubject).get("clients"));
    return new LinkedHashMap<Long, String>(result);
  }

  /**
   * Utility method to sort the map and returned a ordered one (backend with a
   * LinkedHashMap).
   *
  ...
  /**
   * <p>
   * Gets the additional prize for a studio competition.
   * </p>
   *
   ...
   * @since 1.6.7
   */
  public static void setDashboardData(TCSubject currentUser, long contestId, BaseContestCommonDTO dto,
      ContestServiceFacade facade, boolean software) throws Exception {
   ...
   * @since 1.6.7
   */
  public static void setDashboardData(TCSubject currentUser, long contestId,
      ViewSpecificationReviewActionResultData dto, ContestServiceFacade facade, boolean software) throws Exception {
    if (dto.getContestStats() == null) {
      dto.setContestStats(DirectUtils.getContestStats(currentUser, contestId,
          facade.getSoftwareContestByProjectId(currentUser, contestId)));
    }
  ...
  public static void setCopilotDashboardSpecificData(ProjectServices contestService,
      ProjectServiceFacade projectServiceFacade, DirectProjectMetadataService metadataService, long contestId,
   ...
   * @since 1.7.1
   */
  public static boolean hasProjectWritePermission(BaseDirectStrutsAction action, TCSubject tcSubject,
      long directProjectId) throws PermissionServiceException {
    if (!isRole(tcSubject, ADMIN_ROLE)) {

      List<Permission> permissions = action.getPermissionServiceFacade().getPermissionsByProject(tcSubject,
          directProjectId);
   ...
   * @since 1.7.6
   */
  public static boolean hasProjectReadPermission(BaseDirectStrutsAction action, TCSubject tcSubject,
      long directProjectId) throws PermissionServiceException {
    if (!isRole(tcSubject, ADMIN_ROLE)) {
      List<Permission> permissions = action.getPermissionServiceFacade().getPermissionsByProject(tcSubject,
          directProjectId);
      for (Permission p : permissions) {
        if (p.getUserId() == tcSubject.getUserId()) {
          if (p.getPermissionType().getPermissionTypeId() == 1L || p.getPermissionType().getPermissionTypeId() == 2L
  ...
  /**
   * <p>
   * Helper method to clean registrants query results from the cache to reflect
   * the latest addition.
   * </p>
   */
   ...
   * @return the <code>InvoiceType</code> with the specified invoice type name.
   *         Null if not found.
   * @since 1.7.7
   */
   ...
   *
   * @param tcSubject the user.
   * @return true if the user can perform operations on invoice records, false
   *         otherwise.
   * @since 1.7.7
   */
  ...
  public static Map<String, com.topcoder.clients.model.ContestType> getContesetTypes() throws Exception {
    ...
    Map<String, com.topcoder.clients.model.ContestType> contestTypes = new LinkedHashMap<String, com.topcoder.clients.model.ContestType>();

    ResultSetContainer container = dataAccess.getData(request).get("project_categories_replatforming");
  ...
  /**
   * <p>
   * Gets the resource of specified role for specified user for specified contest.
   * </p>
   * 
   * @param userId         a <code>long</code> providing the ID of a user.
   * @param contest        a <code>SoftwareCompetition</code> providing the
   *                       details for contest.
   * @param resourceRoleId a <code>long</code> providing the ID for desired
   *                       resource role.
   * @return a <code>Resource</code> of specified role for existing user or
   *         <code>null</code> if such resource is not found.
   * @since 1.8.4
   */
  ...
  /**
   * <p>
   * Checks if there is a review of specified type by specified reviewer for
   * specified project and specified phase type. This method is intended for
   * phases which require just a single review by single resource (like Approval
   * or Final Review).
   * </p>
   *
   * @param projectServices    a <code>ProjectServices</code> providing interface
   *                           to project services.
   * @param contest            a <code>SoftwareCompetition</code> providing the
   *                           contest details.
   * @param phaseTypeId        a <code>long</code> providing the ID for phase
   *                           type.
   * @param scorecardTypeId    a <code>long</code> providing the ID for scorecard
   *                           type.
  ...
  /**
   * <p>
   * Gets the last closed final fix phase of a specified project.
   * </p>
   * 
   ...
   * @throws UploadPersistenceException if any error occurs when retrieving data
   *                                    from database
   * @throws SearchBuilderException     if any error occurs when searching the
   *                                    uploads
   * @since 1.8.5
   */
  ...
  /**
   * Creates the <code>ProjectBriefDTO</code> from the <code>ProjectData</code>
   * instance.
   *
  ...
  /**
   * <p>
   * Checks if specified user is granted one of the specified permissions for
   * accessing the specified TC Direct project based on the security groups
   * policies.
   * </p>
   *
   * @param tcSubject              a <code>TCSubject</code> representing the
   *                               desired user.
   * @param tcDirectProjectId      a <code>long</code> providing the ID of a TC
   *                               Direct project to check permission for.
   * @param authorizationService   an <code>AuthorizationService</code> providing
   *                               interface to authorization service.
   * @param allowedPermissionTypes a list of permission types which should allow
   *                               the user to access the project.
   * @return <code>true</code> if user is granted permission for accessing the
  ...
  public static boolean hasPermissionBySecurityGroups(TCSubject tcSubject, long tcDirectProjectId,
      AuthorizationService authorizationService, GroupPermissionType... allowedPermissionTypes)
      throws PermissionServiceException {
    try {
      ...
      return false;
      // throw new PermissionServiceException("Failed to authorize user against
      // security groups", e);
    }
  }
  ...
  /**
   * <p>
   * Checks whether the current user is allowed to access Security Groups UI or
   * not.
   * </p>
   *
   * @return <code>true</code> if current user can access Security Groups UI;
  ...
  public static boolean isSecurityGroupsUIAvailable() throws UserServiceException {
    ...
    SecurityGroupsAccessInterceptor securityGroupsAccessInterceptor = (SecurityGroupsAccessInterceptor) applicationContext
        .getBean("securityGroupsAccessInterceptor");
    if (securityGroupsAccessInterceptor.isSecurityGroupsUIAvailable()) {
      SecurityGroupsTcStaffOnlyInterceptor securityGroupsTcStaffOnlyInterceptor = (SecurityGroupsTcStaffOnlyInterceptor) applicationContext
          .getBean("securityGroupsTcStaffOnlyInterceptor");
  ...
  /**
   * Helper method to convert the key of Map<Long, String> to String, returns a
   * Map<String, String>.
   *
  ...
  /**
   * Gets the client id of the given user id. If the user is not a client, 0 is
   * returned.
   *
   * @param userId the id of the user to check.
   * @return the client id of the given user, if the user is not a client, 0 is
   *         returned.
  ...
  /**
   * create file using the input InputStream object, FileLock is used to ensure
   * the file is only created once.
   * 
  ...
  /**
   * Comparator to compare the <code>IdNamePair</code> objects by comparing the
   * name ignore case.
   */
  ...
  /**
   * Update the fixed bug race contest fee and percentage bug race contest fee for
   * TC direct project based on the contest fee settings of the corresponding
   * billing account.
   *
   * @param tcSubject                          a <code>TCSubject</code>
   ...
   *                                           interface.
   * @param projectContestFeePercentageService the project contest fee percentage
   *                                           service interface.
   * @throws Exception if any error occurs.
   * @since 1.10
   */
  public static void updateDirectProjectBugContestFee(TCSubject tcSubject, long projectId,
      ...
      ProjectContestFeePercentageService projectContestFeePercentageService) throws Exception {
    ...
    if (billings.size() > 0) {
      ...
      ProjectContestFeePercentage percentage = projectContestFeePercentageService.getByProjectId(billingAccountId);
  ...
  /**
   * Update the fixed bug race contest fee and percentage bug race contest fee for
   * all TC direct projects associated with the billing account.
   *
   * @param tcSubject                          a <code>TCSubject</code>
   *                                           representing the current user.
  ...
  public static void updateBillingAccountDirectProjectsBugContestFees(TCSubject tcSubject, long billingAccountId,
      ProjectServiceFacade projectService, ProjectContestFeeService projectContestFeeService,
      ProjectContestFeePercentageService projectContestFeePercentageService, DirectProjectService directProjectService)
      throws Exception {
    ...
    for (ProjectDTO project : projects) {
      updateDirectProjectBugContestFee(tcSubject, project.getProjectId(), projectService, projectContestFeeService,
          projectContestFeePercentageService);
    }
  }

  /**
   * <p>
   * Gets the interface to project services.
   * </p>
   *
   * @return a <code>ProjectServices</code> providing the interface to project
   *         services.
   * @since 1.10.2
   */
  ...
  /**
   * <p>
   * Checks whether the Final Fix tab must be shown on the page for the specified
   * contest or not.
   * </p>
   *
   * @param softwareCompetition a <code>SoftwareCompetition</code> providing the
   *                            details for the contest.
   * @return <code>true</code> if Final Fix tab must be shown on the page for the
   *         specified contest; <code>false</code> otherwise.
   * @since 1.10.2
   */
  public static boolean showStudioFinalFixTab(SoftwareCompetition softwareCompetition) {
    ...
    if (lastPhase.getPhaseType().getId() == PhaseType.APPROVAL_PHASE.getId()) {
      ...
      if ((approvalReviews != null) && (approvalReviews.length > 0)) {
        ...
        Comment approvalComment = getReviewCommentByTypeId(CommentType.COMMENT_TYPE_APPROVAL_REVIEW.getId(),
            approvalReview);
  ...
  /**
   * <p>
   * Gets the first comment of specified type from specified review.
   * </p>
   *
   * @param commentTypeId a <code>long</code> providing the ID of comment type.
   * @param review        a <code>Review</code> providing the details for the
   *                      review to lookup for comment in.
   * @return a <code>Comment</code> of specified type from specified review or
   *         <code>null</code> if such a comment is not found.
   * @since 1.10.2
   */
  ...
  /**
   * <p>
   * Registers specified user as resource of specified role to specified contest.
   * </p>
   *
   * @param contestId      a <code>long</code> providing the ID of a contest.
   * @param resourceRoleId a <code>long</code> providing the ID of a role to be
   *                       assigned to user.
   * @param userId         a <code>long</code> providing the ID of a user.
  ...
  private static String[] ORDINAL_SUFFIX = new String[] { "th", "st", "nd", "rd", "th", "th", "th", "th", "th", "th" };
   ...
   * @param time     the expiration time. 0 to delete cookie, negative for session
   *                 cookie.
   * @since 1.7
   */
  ...
  /**
   * Sets up a new token in the session with the specified token name if the
   * existing one is already invalidated.
   *
  ...
  public static CostDTO getChallengeCostData(SoftwareCompetition challenge) {
    ...
    if ("true"
        .equalsIgnoreCase(allProperties.get(ProjectPropertyType.RELIABILITY_BONUS_ELIGIBLE_PROJECT_PROPERTY_KEY))) {
      cost.setReliabilityBonus(parseProjectInfoDoubleValue(reliability));
    }

    if ("on".equalsIgnoreCase(allProperties.get(ProjectPropertyType.DIGITAL_RRUN_FLAG_PROJECT_PROPERTY_KEY))) {
   ...
   * @since 1.8.1
   */
  public static Map<Long, List<TermOfUse>> getUnAgreedProjectTermByUser(long projectId, long roleId, Long[] users)
      throws Exception {
    Connection con = null;
    PreparedStatement ps = null;
    ResultSet rs = null;
  ...
  public static List<Registrant> getMMRegistrants(Long contestId, Long roundId) throws Exception {
    ...
    try {
      ...
      while (rs.next()) {
        ...
        registrant.setRating(rs.getObject(4) != null ? rs.getBigDecimal(4).doubleValue() : null);
