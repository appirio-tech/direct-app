 ...
 *
 * <p>
 * Version 1.1 Changes: - New property directProjectId is added. - New method
 * getDirectProjectCopilots to return copilots of direct project as JSON.
 * </p>
 *
 * <p>
 * Version 1.2 Changes (Module Assembly - Contest Fee Based on % of Member Cost
 * User Part): - Modified method getBillingProjectContestFees. Added support for
 * fee percentage. - If the billing is configured by percentage of member cost,
 * the contest fee will be calculated - as a percentage of the member cost.
 * </p>
 *
 * <p>
 * Version 1.3 Changes (Release Assembly - TopCoder Cockpit Billing Account
 * Project Association) - Add method {@link #getBillingAccountsForProject()} to
 * handle ajax request to get billing accounts for project.
 * </p>
 *
 * <p>
 * Version 1.4 (Release Assembly - TopCoder Direct Cockpit Release Assembly Ten)
 * - Updates method {@link #getBillingAccountsForProject()} to return all the
 * billing accounts of the project without checking the billing account
 * permission of the users.
 * </p>
 * 
 * <p>
 * Version 1.5 (Release Assembly - TopCoder Cockpit - Launch Contest Update for
 * Marathon Match) - New method {@link #getActiveProblemSet()} to return active
 * problems as JSON.
 * </p>
 *
 * <p>
 ...
 * <ul>
 * <li>Adds method {@link #getDirectProjectMilestones()} to get milestones of
 * the specified project by ajax</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <ul>
 * <li>Added method {@link #getDirectProjectContests()} to process the AJAX
 * request to get all the contests of a direct project</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <ul>
 * <li>Updated method {@link #getBillingProjectContestFees()} to include the
 * billing account groups data</li>
 * </ul>
 * </p>
 *
 * <p>
...
public class CommonAction extends BaseContestFeeAction {
  ...
  public String getDirectProjectCopilots() throws Exception {
    ...
    // use map to store the copilots result, key is copilot user id, value is
    // copilot handle
  ...
  /**
   * Handles the ajax request to get all the contests of the direct project
   * specified by the form input <code>directProjectId</code>.
   *
   * @return the result code.
   * @since 1.8
   */
  public String getDirectProjectContests() {
    ...
    try {
      ...
      List<TypedContestBriefDTO> contests = DataProvider
          .getProjectTypedContests(DirectUtils.getTCSubjectFromSession().getUserId(), this.directProjectId);

      // the result list which will be serialized to json and returned by the AJAX
      // response
      List<Map<String, String>> result = new ArrayList<Map<String, String>>();
  ...
  public String getBillingProjectContestFees() throws Exception {
    ...
    List<IdNamePair> groups = DataProvider.getSecurityGroupsForBillingAccount(billingProjectId);
  ...
  public String getBillingAccountsForProject() {
    try {
      // gets the billing accounts associated to the project
      List<Project> billingAccountsByProject = getProjectServiceFacade()
          .getBillingAccountsByProject(getDirectProjectId());
  ...
  public String getCurrentUserRecentProjects() {
    try {
      List<DirectProjectAccess> userRecentDirectProjects = DataProvider
          .getUserRecentDirectProjects(DirectUtils.getTCSubjectFromSession().getUserId());
  ...
  private List<Map<String, Object>> getBillingProjectInfos() throws DAOFault {
    ...
    for (Project project : getProjectServiceFacade()
        .getClientProjectsByUser(DirectStrutsActionsHelper.getTCSubjectFromSession())) {
  ...
  private List<ProjectGroup> getAllProjectGroups() throws ContestServiceException {
    return Arrays
        .asList(getContestServiceFacade().getAllProjectGroups(DirectStrutsActionsHelper.getTCSubjectFromSession()));
  }
