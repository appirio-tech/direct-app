 ...
 * {@link LatestProjectActivitiesDTO.Aware} type and of {@link FormAction} type with form data of {@link ProjectIdForm}
 * type to be passed to it. If any of those requirements is not met then this processor does nothing.</p>
 *
 * @author isv
 * @version 1.0
 */
public class LatestProjectActivitiesProcessor implements RequestProcessor<FormAction<ProjectIdForm>> {
    ...
    /**
     * <p>Constructs new <code>LatestProjectActivitiesProcessor</code> instance. This implementation does nothing.</p>
     */
    public LatestProjectActivitiesProcessor() {
    }
        ...
        if (action instanceof ViewAction) {
            ...
            if (data instanceof LatestProjectActivitiesDTO.Aware) {
                ...
                try {
                    ...
                    log.error("Failed to retrieve details on latest activities on project " + projectId, e);
