 ...
 * <li>add project status in the response.</li>
 * <ul>
 * </ul>
 * <p>
 ...
 * <ul>
 * <li>Add prizes, hasMulti, multiRoundEndDate, projectStudioSpecification,
 * fileTypes to the response.</li>
 * </ul>
 * </p>
 * 
 * <p>
 ...
 * Marathon Match
 * <ul>
 * <li>Update {@link #getMapResult(SoftwareCompetition)} to support marathon
 * match specification.</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <ul>
 * <li>Updated
 * {@link #getMapResult(com.topcoder.service.project.SoftwareCompetition)} to
 * add milestone id and name</li>
 * </ul>
 * </p>
 *
 * <p>
 ...
 * <li>Updated
 * {@link #getMapResult(com.topcoder.service.project.SoftwareCompetition)} to
 * include security group id</li>
 * </ul>
 * </p>
 *
 * <p>
 * Version 1.9 (Release Assembly - TC Cockpit New Challenge types Integration
 * Bug Fixes)
 * <ul>
 * <li>Updated
 * {@link #getMapResult(com.topcoder.service.project.SoftwareCompetition)} to
 * add isReviewPhaseClosed</li>
 * </ul>
 * </p>
 *
 *
 ...
 * <li>Updated
 * {@link #getMapResult(com.topcoder.service.project.SoftwareCompetition)} to
 * add reviewers data</li>
 * </ul>
 * </p>
 *
 * <p>
 * Version 2.1 (TOPCODER DIRECT - IMPROVEMENT FOR PRE-REGISTER MEMBERS WHEN
 ...
 * <ul>
 * <li>Update {@link #getMapResult(SoftwareCompetition)} include registrant
 * id</li>
 * </ul>
 *
 * Version 2.3 (TOPCODER - SUPPORT GROUPS CONCEPT FOR CHALLENGES):
 * <ul>
 * <li>Updated {@link #getMapResult(SoftwareCompetition)}include project groups
 * of challenge</li>
 * </ul>
 *
 * <p>
 * Version 2.4 (Topcoder - Ability To Set End Date For Registration Phase and
 * Submission Phase)
 * <ul>
...
public class SoftwareCompetitionBeanProcessor implements JsonBeanProcessor {
   ...
   * @throws IllegalArgumentException if the bean is not of type
   *                                  <code>StudioCompetition</code>
   */
  ...
  private Object getMapResult(SoftwareCompetition bean) {
    ...
    for (com.topcoder.project.phases.Phase phase : bean.getProjectPhases().getAllPhases()) {
      if (phase.getPhaseType().getName().equals(com.topcoder.project.phases.PhaseType.REVIEW_PHASE.getName())
          && phase.getAttributes().get("Scorecard ID") != null) {
