...
public class CreateContestsTests extends TestCase {
    ...
    public void testFTC1() throws Exception {
		...
		assertEquals("contest information is incorrect", "Client 1 Billing Account 1 Project 2", browser.getText("rswProjectName"));
		assertEquals("contest information is incorrect", "Client 1 Billing Account 1", browser.getText("rswBillingAccount"));
		...
		assertEquals("contest information is incorrect", "11/25/2022 at 00:00 EST (UTC-05)", browser.getText("rswMilestoneDate"));
    ...
    public void testFTC15() throws Exception {
		...
		assertEquals("contest information is incorrect", "Client 1 Billing Account 1 Project 2", browser.getText("rProjectName"));
		assertEquals("contest information is incorrect", "Client 1 Billing Account 1", browser.getText("rBillingAccount"));
		...
		assertEquals("contest information is incorrect", "11/25/2022 at 00:00 EST (UTC-05)", browser.getText("rMilestoneDate"));
    ...
    public void testFTC25() throws Exception {
		...
		browser.click("//a[@href='javascript:continueContestSelection();']");
		Thread.sleep(TestHelper.SLEEP);
		assertTrue("should go to step 2", browser.isElementPresent("dom=document.getElementById('swDetailedRequirements_ifr').contentDocument.body"));
		assertTrue("should go to step 2", browser.isElementPresent("dom=document.getElementById('swGuidelines_ifr').contentDocument.body"));
    ...
    public void testFTC34() throws Exception {
		...
		Thread.sleep(TestHelper.SLEEP);
		assertEquals("the page should not be restored to default value", "Client 1 Billing Account 1 Project 2", browser.getSelectedLabel("projects"));
    }
    ...
    public void testFTC35() throws Exception {
		...
		assertTrue("confirmation dialog should be displayed", browser.isTextPresent("Software Conceptualization Contest test contest has been saved successfully."));
		browser.click("css=span.btnC");
		assertEquals("the project is not saved", "Client 1 Billing Account 1 Project 2", browser.getSelectedLabel("projects"));
    }
    ...
    public void testFTC42() throws Exception {
    	TestHelper.performSoftwareStep1(browser);
		browser.type("dom=document.getElementById('swDetailedRequirements_ifr').contentDocument.body", get12001String());
		browser.type("dom=document.getElementById('swGuidelines_ifr').contentDocument.body", "This is test contest.");
		browser.type("css=#swUploadButtonDiv > input[name='document']", TestHelper.getUploadFile());
		browser.type("swFileDescription", "This is requirement doc.");
		browser.click("swFileUploadBtn");
    ...
    public void testFTC44() throws Exception {
    	TestHelper.performSoftwareStep1(browser);
		browser.type("dom=document.getElementById('swDetailedRequirements_ifr').contentDocument.body", "This is test contest.");
		browser.type("dom=document.getElementById('swGuidelines_ifr').contentDocument.body", get12001String().substring(0, 2049));
		browser.type("css=#swUploadButtonDiv > input[name='document']", TestHelper.getUploadFile());
		browser.type("swFileDescription", "This is requirement doc.");
		browser.click("swFileUploadBtn");
		Thread.sleep(TestHelper.SLEEP);
    ...
    public void testFTC46() throws Exception {
    	TestHelper.performStudioStep1(browser);
		browser.type("dom=document.getElementById('contestIntroduction_ifr').contentDocument.body", get12001String().substring(0, 2001));
		browser.type("dom=document.getElementById('contestDescription_ifr').contentDocument.body", "This is test contest.");
		browser.type("dom=document.getElementById('round1Info_ifr').contentDocument.body", "This is test contest.");
		browser.type("dom=document.getElementById('round2Info_ifr').contentDocument.body", "This is test contest.");
		browser.type("css=#swUploadButtonDiv > input[name='document']", TestHelper.getUploadFile());
    ...
    public void testFTC48() throws Exception {
    	TestHelper.performStudioStep1(browser);
		browser.type("dom=document.getElementById('contestIntroduction_ifr').contentDocument.body", "This is test contest.");
		browser.type("dom=document.getElementById('contestDescription_ifr').contentDocument.body", get12001String().substring(0, 10001));
		browser.type("dom=document.getElementById('round1Info_ifr').contentDocument.body", "This is test contest.");
		browser.type("dom=document.getElementById('round2Info_ifr').contentDocument.body", "This is test contest.");
		browser.type("css=#swUploadButtonDiv > input[name='document']", TestHelper.getUploadFile());
		browser.type("swFileDescription", "This is requirement doc.");
    ...
    public void testFTC50() throws Exception {
		...
		browser.type("dom=document.getElementById('contestIntroduction_ifr').contentDocument.body", "This is test contest.");
		browser.type("dom=document.getElementById('contestDescription_ifr').contentDocument.body", "This is test contest.");
		browser.type("dom=document.getElementById('round1Info_ifr').contentDocument.body", get12001String().substring(0, 2001));
		browser.type("dom=document.getElementById('round2Info_ifr').contentDocument.body", "This is test contest.");
		browser.type("css=#swUploadButtonDiv > input[name='document']", TestHelper.getUploadFile());
		browser.type("swFileDescription", "This is requirement doc.");
		browser.click("swFileUploadBtn");
    ...
    public void testFTC52() throws Exception {
		...
		browser.type("dom=document.getElementById('contestDescription_ifr').contentDocument.body", "This is test contest.");
		browser.type("dom=document.getElementById('round1Info_ifr').contentDocument.body", "This is test contest.");
		browser.type("dom=document.getElementById('round2Info_ifr').contentDocument.body", get12001String().substring(0, 2001));
		browser.type("css=#swUploadButtonDiv > input[name='document']", TestHelper.getUploadFile());
		browser.type("swFileDescription", "This is requirement doc.");
		browser.click("swFileUploadBtn");
		Thread.sleep(TestHelper.SLEEP);
    ...
    public void testFTC56() throws Exception {
		...
		assertEquals("contest information is incorrect for step 3", "Client 1 Billing Account 1 Project 2", browser.getText("rswProjectName"));
		assertEquals("contest information is incorrect for step 3", "Client 1 Billing Account 1", browser.getText("rswBillingAccount"));
    ...
    public void testFTC57() throws Exception {
		...
		assertTrue("should stay in step 2", browser.isElementPresent("dom=document.getElementById('swDetailedRequirements_ifr').contentDocument.body"));
    }
