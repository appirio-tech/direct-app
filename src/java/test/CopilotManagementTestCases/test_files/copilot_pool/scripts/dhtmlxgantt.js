...
/**
 * @desc: show a popup with current date
 * @param: event - (object)event
 * @type: private
 * @topic: 4
 */
GanttChart.prototype.getPopUpTime = function(event)
{
...
GanttChart.prototype.clearItems = function()
{
    ...
    this.oData.firstChild.parentNode.parentNode.appendChild(this.divInfo);
...
GanttChart.prototype.createPanelTasks = function()
{
    ...
    divTasks.style.background = "url(" + this.imgs + "bg.png)";
    return divTasks;
}
/**
...
GanttChart.prototype.addDayInPanelTime = function(row)
{
    ...
    {
        var getPopUpTime = function(event) {
            self.getPopUpTime(event);
        };
        var closePopUpTime = function(event) {
            self.closePopUpTime(event);
        };
        newCell.onmouseover = getPopUpTime;
        newCell.onmouseout = closePopUpTime;

    } else if (this._isIE)
    {
        var getPopUpTime = function() {
            self.getPopUpTime(event);
        };
...
GanttChart.prototype.create = function(divId)
{
    ...
    this.panelTime.appendChild(this.createPanelTime());
    this.panelTime.style.cssText = "position:relative;overflow:hidden;height:34px";
    ...
    //add to control oData and oDataTime
    newCellTblControl = document.createElement("td");
...
GanttTask.prototype.getPopUpInfo = function(object,event)
{
	...
	this.Chart.divInfo.style.top = (posY-this.Chart.oData.scrollTop) + "px";
	this.Chart.divInfo.style.left = (posX-this.Chart.oData.scrollLeft) + "px";
...
GanttTask.prototype.createConnectingLinesPN = function()
{
    ...
    lineVerticalLeft.style.cssText = "border-width: 0px 0px 0px 1px; border-style: dotted; border-color: #EC1C23; margin: 0px; padding: 0px;z-index:10;position: absolute;" +
...
GanttProject.prototype.createDescrProject = function()
{
	...
	if ((this.Chart._isFF) || (this.Chart._isOpera))
    {
        var getPopUpInfo = function(event) {
            if ((!self.Chart._isMove) && (!self.Chart._isResize))  self.getPopUpInfo(self.descrProject,event);
        };
...
GanttProject.prototype.createProjectItem = function()
{
    ...
    {
        var getPopUpInfo = function(event) {
            if ((!self.Chart._isMove) && (!self.Chart._isResize))  self.getPopUpInfo(self.projectItem[0],event);
        };
        var closePopUpInfo = function(event) {
            self.closePopUpInfo(event);
        };
...
/**
 * @desc: get percent completed of the project
 * @type: private
 * @topic: 4
 */
...
/**
 * @desc: Calculation of Duration of Project
 * @type: private
 * @topic: 4
 */
...
GanttTask.prototype.createTaskItem = function()
{
    ...
    if (this.Chart.isEditable) {
        ...
        //background: #00FF33 cursor: e-resize
    ...
    {
        var getPopUpInfo = function(event) {
            if ((!self.Chart._isMove) && (!self.Chart._isResize)) self.getPopUpInfo(self.cTaskItem[0],event);
        };
        var closePopUpInfo = function(event) {
            self.closePopUpInfo(event);
        };
...
contextMenu.prototype._init = function()
{
	...
	tab3.addItem(1,"EST",document.createElement("input"),"text",function(){tab3.arrItems[0].control.focus();});
	tab3.addItem(2,"Move children",document.createElement("input"),"checkbox",function(){tab3.arrItems[1].control.focus();});
	...
	tab6.addItem(1,"New name",document.createElement("input"),"text",function(){tab6.arrItems[0].control.focus();});
	...
	tab9.addItem(3,"EST",document.createElement("input"),"text",function(){tab9.arrItems[2].control.focus();});
	tab9.addItem(4,"Duration",document.createElement("input"),"text",function(){tab9.arrItems[3].control.focus();});
    ...
    tab11.addItem(2,"Name",document.createElement("input"),"text",function(){tab11.arrItems[1].control.focus();});
    tab11.addItem(3,"EST",document.createElement("input"),"text",function(){tab11.arrItems[2].control.focus();});
    tab11.addItem(4,"Duration",document.createElement("input"),"text",function(){tab11.arrItems[3].control.focus();});
    tab11.addItem(5,"Percent complete",document.createElement("input"),"text",function(){tab11.arrItems[4].control.focus();});
	...
	tab10.addItem(3,"EST",document.createElement("input"),"text",function(){tab10.arrItems[2].control.focus();});
	tab10.addItem(4,"Duration",document.createElement("input"),"text",function(){tab10.arrItems[3].control.focus();});
	tab10.addItem(5,"Percent complete",document.createElement("input"),"text",function(){tab10.arrItems[4].control.focus();});
	...
	tab12.addItem(2,"Name",document.createElement("input"),"text",function(){tab12.arrItems[1].control.focus();});
	tab12.addItem(3,"Start date",document.createElement("input"),"text",function(){tab12.arrItems[2].control.focus();});
