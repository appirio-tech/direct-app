	...
	<div id="header">
		<div class="wrapper">
        	<div id="topNav">
            	<div id="logo"></div>
                <ul class="nav">
					<li class="first"><a href="https://topcoder.com/direct/createNewProject.action">START NEW PROJECT</a></li>
					<li><a href="http://info.topcoder.com/blog">BLOG</a></li>
					<li><a href="http://www.topcoder.com/help">HELP</a></li>
					<li class="loginSection"><a href="http://www.topcoder.com/aboutus/">About Us</a></li>
                    <li class="welcomeSection hide"><span class="welcomeMsg">Welcome,[<span class="handle">handle_here</span>]</span><a href="javascript:;" class="logoutLink">LOGOUT</a></li>
				</ul>
            </div>
            <!--end #topNav-->
            <div class="topLinks">
				...
				<div class="right">
					...
					<a href="javascript:;"><img src="in-icon.png" alt=""/></a>
        ...
        <div class="mainBody">
        	<div class="wrapper">
				<div class="contentWrapper">
                    <div class="leftCol">
                    	<a href="https://topcoder.com/direct/createNewProject.action" class="bigBtn"><span class="right"><span class="middle">Start a project now!</span></span></a>
    ...
    <div id="loginModal" class="hide">
        ...
        <div class="content">
        	...
        	<div class="row">
                ...
                <span class="errorMsg passwordErr hide">Incorrect password</span>
            </div>
            <div class="row">
            	<a href="javascript:;" class="forgetPass">Forgot your password?</a>
            </div>
            <div class="row specialRow">
            	<input type="checkbox" class="checkCre"/><span>Remember me in this computer</span>
            </div>
            <div class="row">
    ...
    <div id="registerModal" class="hide">
        ...
        <div class="content">
        	...
        	<div class="row">
                ...
                <img src="/images/ppt/passStren.png" alt="" class="passStren"/>
            ...
            <div class="row">
            	<input type="checkbox" class="checkCre"/><span>I have read and accept the privacy policy</span>
            </div>
            <div class="row">
            	<a href="javascript:;" class="button2 resetBtn"><span class="right"><span class="middle">Reset</span></span></a>
