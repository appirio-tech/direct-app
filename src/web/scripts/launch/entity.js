...
var projectCategoryArray = [
  ...
  { id: 41, name: 'AUTOMATEDTESTING', label: 'Automated Testing', typeId: 2, typeName: 'Application', hasMulti: false, hideInDropdown: false },
...
com.topcoder.direct.SoftwareCompetition = function () {
  ...
  this.isPrivateProject = function () { return this.projectHeader.properties['Private Project Status'] == '1'; }
}
...
com.topcoder.direct.Project = function () {
	  ...
	  this.isLccchecked = function () {
	  	 return this.properties['Confidentiality Type'] == 'standard_cca'
	  }
...
com.topcoder.direct.MainWidget = function () {
  ...
  this.isStudioContest = function () {
  	 return this.competitionType == 'STUDIO'
  }

  this.isSoftwareContest = function () {
  	 return this.competitionType == 'SOFTWARE'
  }

  this.isAlgorithmContest = function () {
    return this.competitionType == 'ALGORITHM'
  }
}
