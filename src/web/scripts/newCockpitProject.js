    ...
    $('#copilotManageModal .saveButton').live('click', function() {
        ...
        if (copilotsData.length == 0) {
            ...
            $.each(copilotsData, function(index, value){
                $("#selectionConfirmationModal .modalContainer dt").append('<dd><span>' + value.copilotHandle + '</span><a href="https://' + SERVER_CONFIG_SERVER_NAME + '/tc?module=MemberProfile&amp;cr='
