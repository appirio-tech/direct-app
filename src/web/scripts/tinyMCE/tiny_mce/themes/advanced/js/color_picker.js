...
function computeColor(e) {
    ...
    x = e.offsetX ? e.offsetX : (e.target ? e.clientX - getPosition(document.getElementById('colors')).left : 0);
	y = e.offsetY ? e.offsetY : (e.target ? e.clientY - getPosition(document.getElementById('colors')).top : 0); 
