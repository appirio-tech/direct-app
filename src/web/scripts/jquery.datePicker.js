			...
			return this.each(
				function()
				{
					...
					if (!alreadyExists && s.createButton) {
						// create it!
						controller.button = $('<a href="javascript:;" class="dp-choose-date" title="' + $.dpText.TEXT_CHOOSE_DATE + '">' + $.dpText.TEXT_CHOOSE_DATE + '</a>')
								.bind(
									'click',
									function()
									{
		...
		{	
			...
			display : function(eleAlignTo)
			{
				...
				if (this.displayClose) {
					$pop.append(
						$('<a href="javascript:;" id="dp-close">' + $.dpText.TEXT_CLOSE + '</a>')
							.bind(
								'click',
								function()
								{
