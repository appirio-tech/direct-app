...
/* init date-pack */
    ...
    function getGroupMembers() {
        ...
        $("#groupMemberTable tbody tr").each(function() {
            ...
            var userId = parseInt($(this).find(".firstColumn input[type='hidden']").val().trim());
            if (!userId) userId = 0;
            if (handle.length > 0) {
