...
<!-- step title -->
<div class="stepTitle">
    <h3><span>1</span>Choose a type and size of project.</h3>
...
<div class="projectItem">
    ...
    <div class="radioBox">
        <input type="radio" name="gamePlanType" class="radio" disabled="disabled"/><label>Project Type 1 (coming soon)</label>
