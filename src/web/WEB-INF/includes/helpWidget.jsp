...
<div id="helpCenterWidget">
    ...
    <div class="tabContent" id="FAQTabContent">
        <ul>
            <li><a href="javascript:;" onclick="window.open('http://www.topcoder.com/help/?p=622')">How to monitor
                Forum Activity?</a></li>
            <li><a href="javascript:;" onclick="window.open('http://www.topcoder.com/help/?p=620')">What is TopCoder
                forum?</a></li>
            <li><a href="javascript:;" onclick="window.open('http://www.topcoder.com/help/?p=618')">How to Extend
                deadline?</a></li>
            <li><a href="javascript:;" onclick="window.open('http://www.topcoder.com/help/?p=616')">How to increase
                Prize?</a></li>
            <li><a href="javascript:;" onclick="window.open('http://www.topcoder.com/help/?p=614')">What can I do once
                a contest is running?</a></li>
            <li><a href="javascript:;" onclick="window.open('http://www.topcoder.com/help/?p=606')">What types of
                forums does TopCoder provide?</a></li>
            <li><a href="javascript:;" onclick="window.open('http://www.topcoder.com/help/?p=604')">How do I know a
    ...
    <p class="contactUs">
        <a href="javascript:;" onclick="window.open('http://www.topcoder.com/help/template-help/')" class="darkenBtn"
