                ...
                handleJsonResult(jsonResult,
                    function(result) {
                        ...
                        for (var i = 0; i < result.count; i++) {
                            ...
                            html = html + '<td class="action"><a href="' + ctx + '/scorecard/show/' + so.id + '" class="view">View</a>&nbsp;|&nbsp;<a href="' + ctx + '/scorecard/edit/' + so.id + '" class="edit">Edit</a><a href="javascript:;" ref="' + so.id + '" class="copy hide">Copy</a></td>';
                            html += '</tr>';
                        }
...
$(document).ready(function() {
    ...
    $('#addSearch a.copy').live('click',function(){
        ...
        $("#addMatch .body").load(ctx + "/scorecard/ajaxContent/" + $(this).attr("ref"), function() {
