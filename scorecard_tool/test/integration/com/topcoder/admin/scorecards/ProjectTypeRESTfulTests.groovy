...
/**
* This class is unit test class for the RESTful service of <code>ProjectType</code>
* domain.
*
* @author TCSASSEMBER
* @version 1.0
*/
class ProjectTypeRESTfulTests extends GroovyTestCase {
    /**
    ...
    */
    void testRESTfulCURD() {
        ...
        assertEquals "test project type", response.data.data.name
        assertEquals "test project type", response.data.data.description
        assertFalse response.data.data.isGeneric
        
        def id = response.data.data.id
        
        // GET (list)
        response = client.get(path: "project-type")
        assertTrue response.data.success
        
        // GET (single item)
        response = client.get(path: "project-type/${id}")
        assertTrue response.data.success
        assertEquals "test project type", response.data.data.name
        assertEquals "test project type", response.data.data.description
        assertFalse response.data.data.isGeneric
        ...
        response = client.put(
            ...
            body: [ data: [ name: "test project type2", description: "test project type2", isGeneric: true, dateCreated: new Date(), lastUpdated: new Date() ] ],
            requestContentType : ContentType.JSON.toString()
        )
        assertTrue response.data.success
        assertEquals "test project type2", response.data.data.name
        assertEquals "test project type2", response.data.data.description
        assertTrue response.data.data.isGeneric
        
        // DELETE
        response = client.delete(path: "project-type/${id}")
        assertTrue response.data.success
        assertEquals "test project type2", response.data.data.name
        assertEquals "test project type2", response.data.data.description
        assertTrue response.data.data.isGeneric
