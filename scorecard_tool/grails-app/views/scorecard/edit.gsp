    ...
    <body>
        ...
        <div id="area1" class="scorecard"><!-- the main area -->
            ...
            <div class="areaHeader">
                <div class="expandCollapse editSaveScorecard">
                    <a class="button6 saveChanges" href="#"><span class="left"><span class="right">SAVE CHANGES</span></span></a>
                    <a class="button6 cancelChanges" href="${createLink(action:'show', id: scorecardInstance.id)}"><span class="left"><span class="right">CANCEL CHANGES</span></span></a>
                </div>
            ...
            <table class="project scorecard view" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><g:textField name="scorecardName" class="mediumText" value="${scorecardInstance.scorecardName}" />&nbsp;<g:textField name="scorecardVersion" class="shortText" value="${scorecardInstance.scorecardVersion}" /></td>
                           ...
                           <table class="scorecard view2 edit section" width="100%" cellpadding="0" cellspacing="0">
                               <tbody class="section">
                                   ...
                                   <tr class="question" rel="${question.id}">
                                       ...
                                       <td>
                                           <select name="questionUploadDocument">
                                               <option value="false" <g:if test="${!question.uploadDocument}">selected="selected"</g:if>>NO</option>
                                               <option value="true" <g:if test="${question.uploadDocument}">selected="selected"</g:if>>YES</option>                                               
                                           </select>
                                       </td>
        ...
        <div id="addWindow" class="dialogContent" style="display: none;">
            <div id="validation" class="addWindow">
                ...
                <div class="foot">
                    <div class="buttons">
                        <a class="button7 closeDialog" href="javascript:void(0)"><span class="left"><span class="right">CANCEL</span></span></a>
                    </div>
                    <div class="clear"></div>
                </div>
            </div><!-- End #validation -->  
            <div id="addManually" class="addWindow">
                ...
                <div class="foot">
                    ...
                    <div class="buttons">
                        <a class="button7 closeDialog" href="javascript:void(0)"><span class="left"><span class="right">CANCEL</span></span></a>
                        <a class="button6 submitBtn" href="javascript:void(0)"><span class="left"><span class="right">SUBMIT</span></span></a>
                    </div>
                    <div class="clear"></div>
                </div>
            </div><!-- End #addManually -->
            ...
            <div id="addScorecard2" class="addWindow">
                ...
                <div class="foot">
                    ...
                    <div class="buttons">
                        <a class="button7 closeDialog" href="javascript:;"><span class="left"><span class="right">CANCEL</span></span></a>
                        <a class="button6 searchBtn" href="javascript:;"><span class="left"><span class="right">SUBMIT</span></span></a>
                    </div>
                    <div class="clear"></div>
                </div>  
            ...
            <div id="addSearch" class="addWindow editSearch">
                <div class="header">
                    ...
                    <a href="javascript:;" class="button7 closeDialog modalTitleBtn"><span class="left"><span class="right">CLOSE</span></span></a>
                </div>
                <div class="body">
                    <div id="addScorecard" class="scorecardSearch">
                       ...
                       <div class="tabHead head">
                           ...
                           <a href="javascript:;" class="button6 apply2 hide"><span class="left"><span class="right">APPLY</span></span></a>                                
                       </div>
                       <!-- overviewBox -->
                                        ...
                                        <div class="container2BottomLeft"><div class="container2BottomRight">
                                            <div class="container2Content">
                                                ...
                                                <table class="projectStats contests" cellpadding="0" cellspacing="0" id="searchResult">
                                                    <thead>
                                                        <tr>
                                                            <th class="first">Scorecard Name&nbsp;&nbsp;<img src="${request.contextPath}/images/down.png" alt="" /></th>
                                                            <th>Type</th>
                                                            <th>Category</th>
                                                            <th>Status</th>
            ...
            <div id="addMatch" class="addWindow">
                ...
                <div class="areaHeader topSpace">
                    ...
                    <div class="expandCollapse">
                        ...
                        <a class="collapseAll" href="javascript:hideGroup('group','ratings');"><strong>Collapse All</strong></a>&nbsp;<a class="button6 green copyScorecard" href="javascript:;"><span class="left"><span class="right">COPY</span></span></a>
                    </div>
            ...
            <table class="scorecard view2 edit example section" width="100%" cellpadding="0" cellspacing="0">
                <tbody class="section">
                    ...
                    <tr class="question hide">
                        ...
                        <td>
                           <select class="questionUploadDocument" name="questionUploadDocument">                               
                               <option value="false">NO</option>
                               <option value="true">YES</option>
                           </select>
                        </td>
