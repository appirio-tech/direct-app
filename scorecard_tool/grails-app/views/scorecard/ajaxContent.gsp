...
<div class="card">
    ...
    <thead>
        <tr>
            ...
            <th colspan="3"><strong>Weight</strong> <span class="groupWeight">${fieldValue(bean: group, field: "weight")}</span></th>
        </tr>
    </thead>
    <tbody class="hide">
    ...
    <tbody>
        ...
        <tr class="question">
           ...
           <td><span class="questionUpload">${question.uploadDocument ? "YES" : "NO"}</span></td>
        </tr>
        </g:each>
    </tbody>
    </table>
