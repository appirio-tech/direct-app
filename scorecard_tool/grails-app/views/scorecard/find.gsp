            ...
            <div class="area1Content">
                ...
                <div id="addScorecard" class="roundedBox addSearch">
                    ...
                    <div class="tabHead head searchResultShow hide">
                        ...
                        <a href="javascript:;" class="button6 apply hide"><span class="left"><span class="right">APPLY</span></span></a>                                
                    </div>
                    <!-- overviewBox -->
                ...
                <div class="buttons searchResultHide">
                    <a class="button7 clearDataFind" href="javascript:;"><span class="left"><span class="right">CLEAR</span></span></a>
                    <a class="button6" href="javascript:;" id="search"><span class="left"><span class="right">SEARCH</span></span></a>                   
                </div><!-- End .buttons -->
