...
* <ul>
*   <li>Changed save closure to persist the uploadDocumentRequired property of ScorecardQuestion set by
*       user.</li>
* </ul>
* </p>
*
                ...
                for (int j = 0; j < group.scorecardSections.size(); j++) {
                    ...
                    for (int k = 0; k < section.scorecardQuestions.size(); k++) {
                        ...
                        questionDomain.properties = [
                            ...
                            'uploadDocumentRequired': question.uploadDocumentRequired,
                            sort: question.sort
                        ]
