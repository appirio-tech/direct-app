...
public class ProjectServiceLocalTestAcc extends BaseUnitTestCase {
    ...
    public void testCreateProject_ByUser() throws Exception {
        ...
        ProjectData newPrjData = this.lookupProjectServiceLocalWithUserRole().createProject(user, projectData);
        ...
        ProjectData created = this.lookupProjectServiceLocalWithUserRole().getProject(user, newPrjData.getProjectId());

        // Verify the result
        this.assertProjectData(newPrjData, created);

        // Delete the created project by user
        this.lookupProjectServiceLocalWithUserRole().deleteProject(user, created.getProjectId());
    }
    ...
    public void testCreateProject_ByAdmin() throws Exception {
        ...
        ProjectData newPrjData = this.lookupProjectServiceLocalWithAdminRole().createProject(admin, projectData);

        assertNotNull("Never return null.", newPrjData);
        assertNotNull("The project id should be updated.", newPrjData.getProjectId());

        // Get the created project by administrator
        ProjectData created = this.lookupProjectServiceLocalWithAdminRole().getProject(admin, newPrjData.getProjectId());

        // Verify the result
        this.assertProjectData(newPrjData, created);

        // Delete the created project by administrator
        this.lookupProjectServiceLocalWithAdminRole().deleteProject(admin, created.getProjectId());
    }
    ...
    public void testCreateProject_CompetitionsShouldBeIgnored() throws Exception {
        ...
        // Create a project by administrator
        ProjectData newPrjData = this.lookupProjectServiceLocalWithAdminRole().createProject(admin, project);
    ...
    public void testGetProject_AdminCanRetrieveAnyProject() throws Exception {
        ...
        // Get the created project by administrator
        ProjectData created = this.lookupProjectServiceLocalWithAdminRole().getProject(user, newPrjData.getProjectId());

        // Verify the result
        this.assertProjectData(newPrjData, created);

        // Delete the created project by administrator
        this.lookupProjectServiceLocalWithAdminRole().deleteProject(user, created.getProjectId());
    }
    ...
    public void testGetProjectsForUser() throws Exception {
        ...
        projectData1 = this.lookupProjectServiceLocalWithUserRole().createProject(user, projectData1);
        projectData2 = this.lookupProjectServiceLocalWithUserRole().createProject(user, projectData2);
        ...
        this.lookupProjectServiceLocalWithUserRole().deleteProject(user, projectDatas.get(0).getProjectId());

        // Delete project by administrator
        this.lookupProjectServiceLocalWithAdminRole().deleteProject(user, projectDatas.get(1).getProjectId());
    }
    ...
    public void testGetAllProjects_ByUser() throws Exception {
        ...
        projectData3 = this.lookupProjectServiceLocalWithAdminRole().createProject(admin, projectData3);
        ...
        // Delete project by user
        this.lookupProjectServiceLocalWithUserRole().deleteProject(user, projectDatas.get(1).getProjectId());

        // Delete project by administrator
        this.lookupProjectServiceLocalWithAdminRole().deleteProject(admin, projectData3.getProjectId());
    }
    ...
    public void testGetAllProjects_ByAdmin() throws Exception {
        ...
        // Delete project by administrator
        this.lookupProjectServiceLocalWithAdminRole().deleteProject(admin, projectDatas.get(2).getProjectId());
    }
    ...
    public void testUpdateProject_ByUser() throws Exception {
        ...
        this.lookupProjectServiceLocalWithUserRole().updateProject(user, newPrjData);

        // Get the updated project by user
        ProjectData updated = this.lookupProjectServiceLocalWithUserRole().getProject(user, newPrjData.getProjectId());

        // Verify the result
        this.assertProjectData(newPrjData, updated);

        // Delete the created project by user
        this.lookupProjectServiceLocalWithUserRole().deleteProject(user, updated.getProjectId());
    }
    ...
    public void testUpdateProject_ByAdmin() throws Exception {
        ...
        this.lookupProjectServiceLocalWithAdminRole().updateProject(admin, newPrjData);

        // Get the updated project by administrator
        ProjectData updated = this.lookupProjectServiceLocalWithAdminRole().getProject(admin, newPrjData.getProjectId());

        // Verify the result
        this.assertProjectData(newPrjData, updated);

        // Delete the created project by administrator
        this.lookupProjectServiceLocalWithAdminRole().deleteProject(admin, updated.getProjectId());
    }
    ...
    public void testDeleteProject_ByUser() throws Exception {
        ...
        assertTrue("Project should be deleted.",
            this.lookupProjectServiceLocalWithUserRole().deleteProject(user, newPrjData.getProjectId()));
    }
    ...
    public void testDeleteProject_ByAdmin() throws Exception {
        ...
        // Delete the created project by administrator
        assertTrue("Project should be deleted.",
            this.lookupProjectServiceLocalWithAdminRole().deleteProject(admin, newPrjData.getProjectId()));
    }
    ...
    public void testDeleteProject_NotFound() throws Exception {
        assertFalse("Should return false.",
            this.lookupProjectServiceLocalWithUserRole().deleteProject(user, Long.MAX_VALUE));
    }
}
