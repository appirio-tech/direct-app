...
public class ProjectServiceWSTestExp extends BaseUnitTestCase {
    ...
    public void testCreateProject_null() throws Exception {
        try {
            this.lookupProjectServiceWSClientWithUserRole().createProject(user, null);
    ...
    public void testCreateProject_nullName() throws Exception {
        try {
            this.lookupProjectServiceWSClientWithUserRole().createProject(user, new ProjectData());
            fail("Expect IllegalArgumentFault.");
        } catch (IllegalArgumentFault e) {
            // expected
        }
    ...
    public void testCreateProject_emptyName() throws Exception {
        ...
        try {
            this.lookupProjectServiceWSClientWithUserRole().createProject(user, projectData);
            fail("Expect IllegalArgumentFault.");
        } catch (IllegalArgumentFault e) {
            // expected
        }
    ...
    public void testGetProject_NotFound() throws Exception {
        try {
            ...
            this.lookupProjectServiceWSClientWithUserRole().getProject(user, Long.MAX_VALUE);
    ...
    public void testGetProject_NotOwned() throws Exception {
        ...
        project = this.lookupProjectServiceWSClientWithAdminRole().createProject(admin, project);

        try {
            // Get the previous created project by user. AuthorizationFailedFault should be thrown
            this.lookupProjectServiceWSClientWithUserRole().getProject(user, project.getProjectId());
            fail("Expect AuthorizationFailedFault.");
        } catch (AuthorizationFailedFault e) {
            // expected
        }

        this.lookupProjectServiceWSClientWithAdminRole().deleteProject(admin, project.getProjectId());
    }
    ...
    public void testUpdateProject_null() throws Exception {
        try {
            this.lookupProjectServiceWSClientWithAdminRole().updateProject(admin, null);
            fail("Expect IllegalArgumentFault.");
        } catch (IllegalArgumentFault e) {
            // expected
        }
    ...
    public void testUpdateProject_nullProjectId() throws Exception {
        ...
        try {
            this.lookupProjectServiceWSClientWithAdminRole().updateProject(admin, projectData);
            fail("Expect IllegalArgumentFault.");
        } catch (IllegalArgumentFault e) {
            // expected
        }
    ...
    public void testUpdateProject_NotOwned() throws Exception {
        ...
        // Create a project by administrator
        projectData = this.lookupProjectServiceWSClientWithAdminRole().createProject(admin, projectData);

        try {
            // Update the previous created project by user. AuthorizationFailedFault should be thrown
            this.lookupProjectServiceWSClientWithUserRole().updateProject(user, projectData);
            fail("Expect AuthorizationFailedFault.");
        } catch (AuthorizationFailedFault e) {
            // expected
        }

        this.lookupProjectServiceWSClientWithAdminRole().deleteProject(admin, projectData.getProjectId());
    }
    ...
    public void testDeleteProject_NotOwned() throws Exception {
        ...
        try {
            ...
            this.lookupProjectServiceWSClientWithUserRole().deleteProject(user, projectData.getProjectId());
            fail("Expect AuthorizationFailedFault");
        } catch (AuthorizationFailedFault e) {
            // expected
        }
    ...
    public void testCreateProject_UserHasNoRole() throws Exception {
        ProjectData projectData = new ProjectData();
        try {
            this.getWSClient("Yoshi").createProject(user, projectData);
            fail("Expect SOAPFaultException.");
        } catch (SOAPFaultException e) {
            // expected
        }
    ...
    public void testGetProject_UserHasNoRole() throws Exception {
        try {
            this.getWSClient("Yoshi").getProject(user, 1L);
            fail("Expect SOAPFaultException.");
        } catch (SOAPFaultException e) {
            // expected
        }
    ...
    public void testGetProjectsForUser_UserHasNoRole() throws Exception {
        ...
        try {
            this.getWSClient("Yoshi").getProjectsForUser(1L);
            fail("Expect SOAPFaultException");
        } catch (SOAPFaultException e) {
            // expected
        }
    ...
    public void testUpdateProject_UserHasNoRole() throws Exception {
        ProjectData projectData = new ProjectData();
        try {
            this.getWSClient("Yoshi").updateProject(user, projectData);
            fail("Expect SOAPFaultException.");
        } catch (SOAPFaultException e) {
            // expected
        }
    ...
    public void testDeleteProject_UserHasNoRole() throws Exception {
        try {
            this.getWSClient("Yoshi").deleteProject(user, 1L);
            fail("Expect SOAPFaultException");
        } catch (SOAPFaultException e) {
            // expected
        }
    ...
    public void testGetAllProjects_UserHasNoRole() throws Exception {
        try {
            this.getWSClient("Yoshi").getAllProjects();
            fail("Expect SOAPFaultException");
        } catch (SOAPFaultException e) {
            // expected
        }
