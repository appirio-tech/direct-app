...
public class ProjectServiceRemoteTestExp extends BaseUnitTestCase {
    ...
    public void testCreateProject_null() throws Exception {
        try {
            this.lookupProjectServiceRemoteWithUserRole().createProject(user, null);
    ...
    public void testCreateProject_nullName() throws Exception {
        try {
            this.lookupProjectServiceRemoteWithUserRole().createProject(user, new ProjectData());
            fail("Expect IllegalArgumentFault.");
        } catch (IllegalArgumentFault e) {
            // expected
        }
    ...
    public void testCreateProject_emptyName() throws Exception {
        ...
        try {
            this.lookupProjectServiceRemoteWithUserRole().createProject(user, projectData);
            fail("Expect IllegalArgumentFault.");
        } catch (IllegalArgumentFault e) {
            // expected
        }
    ...
    public void testGetProject_NotFound() throws Exception {
        try {
            ...
            this.lookupProjectServiceRemoteWithUserRole().getProject(user, Long.MAX_VALUE);
    ...
    public void testGetProject_NotOwned() throws Exception {
        ...
        project = this.lookupProjectServiceRemoteWithAdminRole().createProject(admin, project);

        try {
            // Get the previous created project by user. AuthorizationFailedFault should be thrown
            this.lookupProjectServiceRemoteWithUserRole().getProject(user, project.getProjectId());
            fail("Expect AuthorizationFailedFault.");
        } catch (AuthorizationFailedFault e) {
            // expected
        }

        this.lookupProjectServiceRemoteWithAdminRole().deleteProject(admin, project.getProjectId());
    }
    ...
    public void testUpdateProject_null() throws Exception {
        try {
            this.lookupProjectServiceRemoteWithAdminRole().updateProject(admin, null);
            fail("Expect IllegalArgumentFault.");
        } catch (IllegalArgumentFault e) {
            // expected
        }
    ...
    public void testUpdateProject_nullProjectId() throws Exception {
        ...
        try {
            this.lookupProjectServiceRemoteWithAdminRole().updateProject(admin, projectData);
            fail("Expect IllegalArgumentFault.");
        } catch (IllegalArgumentFault e) {
            // expected
        }
    ...
    public void testUpdateProject_NotOwned() throws Exception {
        ...
        // Create a project by administrator
        projectData = this.lookupProjectServiceRemoteWithAdminRole().createProject(admin, projectData);

        try {
            // Update the previous created project by user. AuthorizationFailedFault should be thrown
            this.lookupProjectServiceRemoteWithUserRole().updateProject(user, projectData);
            fail("Expect AuthorizationFailedFault.");
        } catch (AuthorizationFailedFault e) {
            // expected
        }

        this.lookupProjectServiceRemoteWithAdminRole().deleteProject(admin, projectData.getProjectId());
    }
    ...
    public void testDeleteProject_NotOwned() throws Exception {
        ...
        try {
            ...
            this.lookupProjectServiceRemoteWithUserRole().deleteProject(user, projectData.getProjectId());
            fail("Expect AuthorizationFailedFault");
        } catch (AuthorizationFailedFault e) {
            // expected
        }
    ...
    public void testCreateProject_UserHasNoRole() throws Exception {
        ProjectData projectData = new ProjectData();
        try {
            ((ProjectServiceRemote) getInitialContext("Yoshi")
                    .lookup("remote/ProjectServiceBean")).createProject(user, projectData);
            fail("Expect EJBAccessException.");
        } catch (EJBAccessException e) {
            // expected
        }
    ...
    public void testGetProject_UserHasNoRole() throws Exception {
        try {
            ((ProjectServiceRemote) getInitialContext("Yoshi")
                    .lookup("remote/ProjectServiceBean")).getProject(user, 1L);
            fail("Expect EJBAccessException.");
        } catch (EJBAccessException e) {
            // expected
        }
    ...
    public void testUpdateProject_UserHasNoRole() throws Exception {
        ...
        try {
            ((ProjectServiceRemote) getInitialContext("Yoshi")
                    .lookup("remote/ProjectServiceBean")).updateProject(user, projectData);
            fail("Expect EJBAccessException.");
        } catch (EJBAccessException e) {
            // expected
        }
    ...
    public void testDeleteProject_UserHasNoRole() throws Exception {
        try {
            ((ProjectServiceRemote) getInitialContext("Yoshi")
                    .lookup("remote/ProjectServiceBean")).deleteProject(user, 1L);
            fail("Expect EJBAccessException");
        } catch (EJBAccessException e) {
            // expected
        }
