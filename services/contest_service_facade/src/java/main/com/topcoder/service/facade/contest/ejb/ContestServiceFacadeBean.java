 ...
 * retrieve all permissions by projectId. Version 1.0.1 (Cockpit Release
 * Assembly 5 v1.0) Change Notes: - Added method to retrieve contest fees by
 * given billing project id.
 * </p>
 * </p>
 * Version 1.0.2 (Spec Reviews Finishing Touches v1.0) Change Notes: - Made the
 * getSpecReviews method return instance of SpecReview rather than a list. -
 * Added the methods to mark ready for review, review done and resubmit for
 * review.
 * </p>
 * <p>
 * Version 1.0.3 (Cockpit Software Contest Payments v1.0) Change notes: - For
 * software contest, payment is made for the sum of various costs. - While doing
 * so, only the increased amount is paid (if earlier payments were made). -
 * Introduced constants for new cost types
 * </p>
 * <p>
 * Version 1.0.4 - Add 'Applications'/'Components' to resource for project
 * </p>
 * -----------------------changed in the version 1.1----------------- Four
 * methods are added
 ...
 *
 * <p>
 * Changes in v1.2 (Studio Multi-Rounds Assembly - Launch Contest): Added
 * default checkpoint date when contest is created.
 * </p>
 * <p>
 * Changes in v1.2.1 updated to set creator user as Observer created.
 * </p>
 * <p>
 * Changes in v1.2.2 - Cockpit Release Assembly 11 Add method
 * getDesignComponents to get design components.
 * </p>
 * <p>
 * Changes in v1.3 (Prototype Conversion Studio Multi-Rounds Assembly -
 * Submission Viewer UI): - Added a flag to updateSubmissionUserRank method to
 * support ranking checkpoint submissions. - Added support for checkpoint prizes
 * payment.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Changes in v1.4 (Cockpit Spec Review Backend Service Update v1.0): - Added
 * method to create specification review project for an existing project. -
 * Added method to get scorecard and review information for a specific project.
 * - Added method to upload a mock submission / final fixes to the associated
 * specification review of a project to make it ready for review. - Added method
 * to add comments to an existing review.
 * </p>
 * <p>
 * Change in v1.4.1 (Cockpit Spec Review -stage 2 v1.0) - Add spec review
 * project id - After activiation of contests, create spec review project
 * </p>
 * <p>
 * Changes in v1.5 (Cockpit Release Assembly - Contest Repost and New Version
 * v1.0): - Added method to re open failed software contest. - Added method to
 * create new version for development or design contest. - Refactor the
 * create/update-software-contest methods
 * </p>
 * <p>
 * Changes in v1.5.1(Cockpit Security Facade V1.0): - It is not a web-service
 * any more. - All the methods accepts a parameter TCSubject which contains all
 * the security info for current user. The implementation EJB should use
 * TCSubject and now get these info from the sessionContext. - Please use the
 * new ContestServiceFacadeWebService as the facade now. That interface will
 * delegates all the methods to it. - UserService is used to get the user-name
 * for the given user-id.
 * </p>
 * <p>
 * Changes in v1.6(Direct Search Assembly v1.0): Adds getProjectData method to
 * return project data with aggregate contest information in different status.
 * Change getCommonProjectContestData method to add payment information.
 * </p>
 * <p>
 * Changes in v1.6.1, two public methods are added (BUGR - 3706): -
 * List<ProjectNotification> getNotificationsForUser(TCSubject subject, long
 * userId) - updateNotifcationsForUser(TCSubject subject, long userId,
 * List<ProjectNotification> notifications)
 * </p>
 *
 * <p>
 * Version 1.6.2 (Direct Permissions Setting Back-end and Integration Assembly
 * 1.0) Change notes:
 * <ol>
 ...
 * <ol>
 * <li>Added {@link #updateSubmissionsGeneralFeedback(TCSubject, long, String)}
 * method.</li>
 * </ol>
 * </p>
 *
 * <p>
 * Version 1.6.4 (TC Direct - Launch Copilot Selection Contest assembly 1.0)
 * Change notes:
 * <ol>
 * <li>Added {@link #COPILOT_CONTEST_PROJECT_CATEGORY_ID} field and
 * {@link #isCopilotContest(SoftwareCompetition)} method, update
 * {@link #createUpdateAssetDTO} method.</li>
 * </ol>
 * </p>
 * <p>
 ...
 * <li>Add
 * {@link #processContestCreditCardSale(TCSubject, SoftwareCompetition, CreditCardPaymentData, Date)}
 * method.</li>
 * <li>Update
 * {@link #processContestCreditCardSale(TCSubject, SoftwareCompetition, CreditCardPaymentData)}
 * method.</li>
 * <li>Add
 * {@link #processContestPurchaseOrderSale(TCSubject, SoftwareCompetition, TCPurhcaseOrderPaymentData, Date)}
 * method.</li>
 * <li>Update
 * {@link #processContestPurchaseOrderSale(TCSubject, SoftwareCompetition, TCPurhcaseOrderPaymentData)}
 * method.</li>
 * <li>Update
 * {@link #processContestSaleInternal(TCSubject, SoftwareCompetition, PaymentData, Date)}
 * method.</li>
 * <li>Add
 * {@link #createSoftwareContest(TCSubject, SoftwareCompetition, long, Date)}
 * method.</li>
 * <li>Update
 * {@link #createSoftwareContest(TCSubject, SoftwareCompetition, long)}
 * method.</li>
 * <li>Add
 * {@link #updateSoftwareContest(TCSubject, SoftwareCompetition, long, Date)}
 * method.</li>
 * <li>Update
 * {@link #updateSoftwareContest(TCSubject, SoftwareCompetition, long)}
 * method.</li>
 * <li>Add {@link #getAllFileTypes()} method.</li> <ii>Update
 * {@link #createUpdateAssetDTO(TCSubject, SoftwareCompetition)} method to
 * create forums for studio contest.</li>
 * <li>Add {@link #createStudioForum(String, long)} method and update
 * {@link #createForum(TCSubject, AssetDTO, long, long)} method.</li>
 ...
 *          <ol>
 *          <li>Updated {@link #updateProjectPermissions(TCSubject,
 *          List<ProjectPermission>, long)} method.</li>
 *          </ol>
 *          </p>
 *
 *          <p>
 ...
 *          <li>Updated
 *          {@link #processContestSaleInternal(TCSubject, SoftwareCompetition, PaymentData, Date)}
 *          method to process checkpoint prizes for software contest and
 *          specification review cost for studio contest.</li>
 *          </ul>
 *          </p>
 *
 * @author snow01, pulky, murphydog, waits, BeBetter, hohosky, isv, tangzx,
 ...
 * @version 1.6.8
 *          <p>
 *          Version 1.6.8 (TC Direct - Software Contest Creation Update) Change
 *          notes:
 *          <ol>
 *          <li>Update method <code>createContestResources</code> to create
 *          copilot resource and set form permission/watch if exists.</li>
 *          <li>Update method <code>updateContestResources</code> to update
 *          copilots and update forum permission/watch</li>
 *          </ol>
 *          </p>
 *
 *          <p>
 ...
 *          </p>
 *          <p>
 *          Version 1.7.0 Release Assembly - Direct Improvements Assembly
 *          Release 3 Change notes:
 *          <ol>
 *          <li>add the logic to judge whether a pay is activation or additional
 *          pay and send different emails</li>
 *          <li>correct the direct project name in the payment email of software
 *          and studio competition.</li>
 *          </ol>
 *          </p>
 *
 *          <p>
 ...
 *          <ul>
 *          <li>Add {@link #getCheckpointSubmissions(long)} method to get the
 *          checkpoint submissions in OR.</li>
 *          <li>Add
 *          {@link #getStudioSubmissionFeedback(TCSubject, long, long, PhaseType)}
 *          method to get client feedback for a specified submission.</li>
 *          <li>Add
 *          {@link #saveStudioSubmisionWithRankAndFeedback(TCSubject, long, long, int, String, Boolean, PhaseType)}
 *          method to save placement and client feedback for a specified
 *          submission.</li>
 *          <li>Add {@link #updateSoftwareSubmissions(TCSubject, List)} method
 *          to update the submissions in OR.</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 ...
 *          <ul>
 *          <li>Changed method name from <code>getCheckpointSubmissions</code>
 ...
 *          <ul>
 *          <li>Fixed forums management logic to update Studio and Software
 *          forums correctly.</li>
 *          </ul>
 *
 *          <p>
 *          Version 1.7.1 Release Assembly - TopCoder Cockpit Project Status
 *          Management Change notes:
 *          <ul>
 *          <li>Set cockpit project status id in
 *          {@link #getProjectData(com.topcoder.security.TCSubject)}</li>
 *          </ul>
 *
 *          <p>
 *          Version 1.7.2 (TopCoder Cockpit Project Overview R2 Project Forum
 *          Backend Assembly 1.0) Change notes:
 *          <ol>
 *          <li>Added createTopCoderDirectProjectForum(TCSubject, long, Long)
 *          method.</li>
 ...
 *
 *          <p>
 *          Version 1.7.5 (Release Assembly - TopCoder Cockpit DataTables Filter
 *          Panel and Search Bar) Change notes:
 *          <ol>
 *          <li>Add project creation date to
 *          {@link #getProjectData(com.topcoder.security.TCSubject)}</li>
 *          </ol>
 *          </p>
 *
 *          <p>
 *          Version 1.8.0 (Release Assembly - TC Cockpit Create Project
 *          Refactoring Assembly Part One) Change notes:
 *          <ul>
 *          <li>Refactor all the permission related methods to permission
 *          service facade</li>
 *          <li>Change the invokes of permission related methods to call
 *          permission service facade</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 *          Version 1.8.2 (Release Assembly - TC Direct Cockpit Release Two
 *          version 1.0) Change notes:
 *          <ul>
 *          <li>Update
 *          {@link #selectCopilot(com.topcoder.security.TCSubject, long, long, long, int, long)}
 *          to support 'not choose 2nd copilot'</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 *          Version 1.8.3 (Release Assembly - TopCoder Bug Hunt Assembly
 *          Integration 2) change notes:
 *          <ul>
 *          <li>Add contant {@link #RESOURCE_INFO_PAYMENT}</li>
 *          <li>Add method
 *          {@link #shouldAutoCreateBugHuntContest(com.topcoder.service.project.SoftwareCompetition)}
 *          to check whether the contest to create needs a bug hunt contest auto
 *          created.</li>
 *          <li>Add method
 *          {@link #autoCreateBugHuntContest(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, com.topcoder.service.project.SoftwareCompetition, java.util.Date)}
 *          to set up the bug hunt contest for auto creation.</li>
 *          <li>Update method
 *          {@link #createContestResources(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long)}
 *          to auto insert the reviewer for bug hunt contest.</li>
 *          <li>Update method
 *          {@link #createUpdateAssetDTO(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition)}
 *          to reuse the asset DTO for auto bug hunt contest.</li>
 *          <li>Update method
 *          {@link #createSoftwareContest(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, java.util.Date, java.util.Date)}
 *          to automatically create bug hunt contest for assembly contest.</li>
 *          </ul>
 *          </p>
 *          <p>
 *          Version 1.8.4 (System Assembly - TopCoder Security Groups Frontend -
 *          Permission Propagation Integration) Change notes:
 *          <ul>
 *          <li>Added fields {@link #securityGroupsHibernateConfig},
 *          {@link #authorizationService}.</li>
 *          <li>Updated {@link #init()} to create the AuthorizationService
 *          instance.</li>
 *          <li>Added
 *          {@link #checkGroupPermissionForProject(TCSubject, long, boolean)} to
 *          check group permission for project.</li>
 *          <li>Updated
 *          {@link #checkSoftwareProjectPermission(TCSubject, long, boolean)}
 *          and
 *          {@link #checkSoftwareContestPermission(TCSubject, long, boolean)} to
 *          call new helper method
 *          {@link #checkGroupPermissionForProject(TCSubject, long, boolean)}
 *          before throwing exception.</li>
 *          </ul>
 *          </p>
 *          <p>
 *          Version 1.8.4 (Release Assembly - TC Direct Cockpit Release Three
 *          version 1.0)
 *          <ul>
 *          <li>Add {@link #customContestActivationEmailTempaltes},
 *          {@link #customActivateContestReceiptContestTypeIds} and
 *          {@link #customActivateContestReceiptEmailTemplatePaths} to stores
 *          the custom activation email tempaltes configuration for different
 *          contest types.</li>
 *          <li>Add the logic in {@link #processContestSaleInternal} to
 *          dynamically choose email template according to contest type.</li>
 *          <li>Fix the amount of total member cost and total cost in activation
 *          email.</li>
 *          <li>Use the total member cost and total cost in the email sent when
 *          prize gets edited.</li>
 *          </ul>
 *          </p>
 *          <p>
 *          Version 1.8.5 (Release Assembly - TC Direct Cockpit Release Four
 *          version 1.0)
 *          <ul>
 *          <li>Update to start spec review when activating contest.</li>
 *          <li>Update to sending copilot winner email when picking copilot
 *          posting winner.</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 *          Version 1.8.6 (Release Assembly - TC Direct Issue Tracking Tab
 *          Update Assembly 2 v1.0) change notes:
 *          <ol>
 *          <li>Added method {@link #getActiveUploads(long, int)} to retrieve
 *          the active uploads.</li>
 *          </ol>
 *          </p>
 *
 *          <p>
 *          Version 1.8.6 (Release Assembly - TopCoder Cockpit Project Dashboard
 *          Project Type and Permission Notifications Integration)
 *          <ul>
 *          <li>Fixed {@link #updateNotificationsForUser} not use
 *          <code>userId</code> argument when update forum notification.</li>
 *          </ul>
 *          </p>
 *          <p>
 *          Version 1.8.7 (Release Assembly - TopCoder Cockpit Software
 *          Checkpoint Management) change notes:
 *          <ul>
 *          <li>Added
 *          {@link #saveSoftwareCheckpointReviewWithRankAndFeedback(TCSubject, long, long[], int[], String[], Boolean, String)}
 ...
 *
 *          <p>
 *          Version 1.9.0 (Module Assembly - TC Cockpit Project Contests Batch
 *          Edit) changes:
 *          <ul>
 *          <li>Add method
 *          {@link #deleteSoftwareContests(com.topcoder.security.TCSubject, long, java.util.List)}</li>
 *          <li>Add method
 *          {@link #batchUpdateDraftSoftwareContests(com.topcoder.security.TCSubject, long, java.util.List)}</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 *          Version 1.9.1 (Release Assembly - TopCoder Cockpit Post Software
 *          Checkpoint Feedback to Forum v1.0) changes:
 *          <ul>
 *          <li>Updated method
 *          {@link #saveSoftwareCheckpointReviewWithRankAndFeedback(TCSubject, long, long[], int[], String[], Boolean, String)}
 *          to post feedbacks to forums.</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 *          Version 1.9.2 (Release Assembly - TopCoder Security Groups Release 5
 *          v1.0) changes:
 *          <ul>
 *          <li>Updated method
 *          {@link #checkGroupPermissionForProject(TCSubject, long, boolean)} to
 *          fix the bug when checking whether a user has read permission on a
 *          project.</li>
 *          </ul>
 *          </p>
 *
 ...
 *          {@link #createSoftwareContest(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, java.util.Date, java.util.Date)}</li>
 *          <li>Update the method
 *          {@link #updateSoftwareContest(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, java.util.Date, java.util.Date)}</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 ...
 *          <li>Update the method
 *          {@link #createSoftwareContest(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, java.util.Date, java.util.Date)}
 *          to add checking of contest billing account</li>
 *          <li>Update the method
 *          {@link #updateSoftwareContest(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, java.util.Date, java.util.Date)}
 *          to add the checking of contest billing account</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 *          Version 1.9.4 (Release Assembly - TC Cockpit Operations Dashboard
 *          Improvements 2) changes:
 *          <ul>
 *          <li>Updated method {@link #processContestSaleInternal} to set
 *          'Historical Projected Cost' and 'Project Activate Date'.</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 ...
 *          <ol>
 *          <li>Add {@link #addReviewAuction(SoftwareCompetition)} to add review
 *          auction when activate contest.</li>
 *          <li>Add {@link #reviewAuctionManager} to process review
 *          auctions.</li>
 ...
 *
 *          <p>
 *          Version 1.9.6 (Release Assembly - TopCoder Cockpit Copilot Selection
 *          Update and Other Fixes Assembly)
 *          <ol>
 *          <li>Update signature of method selectCopilot to
 *          {@link #selectCopilot(com.topcoder.security.TCSubject, long, long, long, long, long)}
 *          and update the method to pick up copilot posting 1st and 2nd place
 *          in one transaction</li>
 *          </ol>
 *          </p>
 *
 *          Version 1.9.7 BUGR-8788 (TC Cockpit - New Client Billing Config
 *          Type) change notes:
 *          <ul>
 *          <li>Add {@link #requireBillingProjectCCA(long)} to check cca status
 *          of billing account</li>
 *          <li>Add {@link #requireBillingProjectsCCA(long[])} to check cca
 *          status of some of billing accounts</li>
 *          <li>Add {@link #checkBillingProjectCCA(SoftwareCompetition)} to
 *          check and update cca status of project header</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 *          Version 1.9.8 (Module Assembly - TC Cockpit - Studio - Final Fixes
 *          Integration Part One Assembly) Change notes:
 *          <ol>
 *          <li>Updated {@link #getSoftwareContestByProjectId(TCSubject, long)}
 *          method to remove the block of code which was clearing the
 *          dependencies and project from the project phases. This was not
 *          correct.</li>
 *          <li>Updated
 *          {@link #getStudioSubmissionFeedback(TCSubject, long, long, PhaseType)}
 *          to support getting feedbacks from Approval reviews.</li>
 *          </ol>
 *          </p>
 *
 *          <p>
 *          Version 1.9.9 (Module Assembly - TC Cockpit Contest Milestone
 *          Association 1) change notes:
 *          <ul>
 *          <li>Updated
 *          {@link #createSoftwareContest(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, java.util.Date, java.util.Date)}
 *          to add contest and milestone association when creating the new
 *          contest</li>
 *          <li>Updated
 *          {@link #updateSoftwareContest(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, java.util.Date, java.util.Date)}
 *          to update contest and milestone association when updating a
 *          contest</li>
 *          <li>Add
 *          {@link #getSoftwareContestByProjectId(com.topcoder.security.TCSubject, long)}
 *          to include contest milestone association data in the retrieved
 *          contest data</li>
 *          </ul>
 *          </p>
 *
 ...
 *          <ul>
 *          <li>Added method
 *          {@link #isCodeContest(com.topcoder.service.project.SoftwareCompetition)}
 *          to check if the contest is of type Code</li>
 *          <li>Updated method
 *          {@link #createUpdateAssetDTO(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition)}
 *          to set project properties For Code to disable Rated, DR, Reliability
 *          Eligible, and Approval.</li>
 *
 *          </ul>
 *          </p>
 *
 ...
 *          <ul>
 *          <li>Added method
 *          {@link #isF2FContest(com.topcoder.service.project.SoftwareCompetition)}
 *          to check if the contest is of type First2Finish</li>
 *          <li>Updated method
 *          {@link #createUpdateAssetDTO(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition)}
 *          to set project properties For First2Finish to disable Rated, DR,
 *          Reliability, Approval and allow multiple submissions.</li>
 *          <li>Added method {@link #getAllProjectPlatforms()} to get all
 *          project platform options</li>
 *
 *          </ul>
 *          </p>
 *
 *          <p>
 *          Version 2.0.2 (Release Assembly - Publish Event on Contest Creation
 *          in TopCoder Cockpit) change notes:
 *          <ul>
 *          <li>Added {@link #amazonSNSClient} used to publish SNS event.</li>
 *          <li>Added {@link #contestCreationArn} used to represent arn.</li>
 *          <li>Added {@link #contestCreationSubject} used to represent
 *          subject.</li>
 *          <li>Added {@link #contestCreationMessageTemplate} used to represent
 *          template.</li>
 *          <li>Added {@link #AWS_CREDENTIALS_FILE} to represent aws credentials
 *          file.</li>
 *          <li>Updated
 *          {@link #createSoftwareContest(TCSubject, SoftwareCompetition, long, Date, Date)}
 *          to publish event.</li>
 ...
 *          <li>Updated method
 *          {@link #persistContestEligility(com.topcoder.management.project.Project, com.topcoder.service.contest.eligibility.ContestEligibility, boolean)}
 *          to use the security group specified in the
 *          SoftwareCompeitition.ProjectHeader.SecurityGroupId</li>
 *          <li>Updated method
 *          {@link #getSoftwareContestByProjectId(com.topcoder.security.TCSubject, long)}
 *          to set the SecurityGroupId of the contest</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 *          Version 2.2 (TC Cockpit Auto Assign Reviewer for First2Finish
 *          challenge)
 *          <ul>
 *          <li>Updated
 *          {@link #createContestResources(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, boolean)}
 *          to add Iterative Reviewer Resource from the passed-in
 *          SoftwareCompetition</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 ...
 *
 *          <p>
 *          Version 2.4 (Release Assembly - TC Cockpit New Challenge types
 *          Integration Bug Fixes)
 *          <ul>
 *          <li>Updated method
 *          {@link #updateSoftwareContest(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, java.util.Date, java.util.Date)}
 *          to handle the deletion of contest milestone association.</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 ...
 *          <li>Updated
 *          {@link #createContestResources(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, boolean)}
 *          to add auto assigned reviewer</li>
 *          <li>Added {@link #createIterativeReviewerResource(long, long, long)}
 *          to create iterative reviewer resource</li>
 *          <li>Added {@link #createReviewerResource(long, long, long, boolean)}
 *          to create reviewer resource</li>
 *          <li>Updated
 *          {@link #updateSoftwareContest(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long)}
 *          to auto add reviewer for F2F/Code when updating contest</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 ...
 *          <ul>
 *          <li>Updated
 *          {@link #processContestSaleInternal(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, com.topcoder.service.payment.PaymentData, java.util.Date, java.util.Date)}
 *          to send Amazon SNS when activating challenge with CMC Task ID
 *          assigned</li>
 *          <li>Updated
 *          {@link #updateSoftwareContest(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, java.util.Date, java.util.Date)}
 *          send Amazon SNS when updating start date, end date of the
 *          challenge</li>
 *          </ul>
 *          </p>
 *
 ...
 *          <li>Updated
 *          {@link #createContestResources(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, boolean)}
 *          to set launcher as manager is it's not copilot</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 ...
 *          <li>Updated
 *          {@link #autoCreateBugHuntContest(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, com.topcoder.service.project.SoftwareCompetition, java.util.Date)}
 *          to set second prize of auto created bug hunt to 0</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 ...
 *          <li>Updated
 *          {@link #updateSoftwareContest(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, java.util.Date, java.util.Date)}
 *          to prevent update activated contest to draft</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 *          Version 3.0 (Module Assembly - TC Direct Studio Design First2Finish
 *          Challenge Type)
 *          <ul>
 *          <li>Added method
 *          {@link #isDesignF2FContest(com.topcoder.service.project.SoftwareCompetition)}</li>
 *          <li>Updated method
 *          {@link #createUpdateAssetDTO(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition)}
 *          to set allow multiple submission to true of Design First2Finish and
 *          turn off rate, reliability, approval, DR</li>
 *          <li>Updated {@link #saveStudioSubmisionWithRankAndFeedback} to close
 *          the reg and sub for Design First2Finish because processing the auto
 *          review</li>
 *          </ul>
 *          </p>
 *
 *          <p>
 *          Version 3.1 (Release Assembly - Port Design Challenge Forum to use
 *          Dev Forum)
 *          <ul>
 *          <li>Added {@link #studioForumRootCategoryId}</li>
 *          <li>Added method {@link #init()} to read studioForumRootCategoryId
 *          from configuration</li>
 *          <li>Updated method
 *          {@link #createUpdateAssetDTO(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition)}
 *          to set the FORUM_TYPE project info</li>
 *          <li>Updated method {@link #createStudioForum(String, long)} to use
 *          software forum EJB and call the new method createStudioForumV2</li>
 *          <li>Updated method
 *          {@link #createStudioForumWatchAndRole(long, long, boolean)} to use
 *          software forum EJB</li>
 *          <li>Updated method
 *          {@link #deleteStudioForumWatchAndRole(long, long)} to use software
 *          forum EJB instead</li>
 *          <li>Updated method {@link #updateStudioForumName(long, String)} to
 *          use software forum EJB instead</li>
 *          <li>Updated method
 *          {@link #getNotificationsForUser(com.topcoder.security.TCSubject, long)}
 *          to use software forum EJB for studio contests</li>
 *          <li>Updated method
 *          {@link #updateNotificationsForUser(com.topcoder.security.TCSubject, long, java.util.List)}
 *          to use software forum EJB for studio contests</li>
 *          </ul>
 *          </p>
 *
 ...
 *          <li>Updated
 *          {@link #createContestResources(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition, long, boolean)}
 *          to add Appirio Manager as manager resource if it's in the passed-in
 *          competition object</li>
 *          </ul>
 *          </p>
 *
 *          Version 3.3 (Provide Way To Pre_register members When Launching
 *          Challenge)
 *          <ul>
 *          <li>Updated
 *          {@link #processContestSaleInternal(TCSubject, SoftwareCompetition, PaymentData, Date, Date)}
 *          pre-register member for private challenge will be added for first
 *          time activation</li>
 *          <li>Added
 *          {@link #updatePreRegister(TCSubject, SoftwareCompetition, Set)}
 *          method</li>
 *          </ul>
 *
 *          Version 3.4 (TOPCODER DIRECT - IMPROVEMENT FOR PRE-REGISTER MEMBERS
 *          WHEN LAUNCHING CHALLENGES)
 *          <ul>
 *          <li>Updated
 *          {@link #updatePreRegister(TCSubject, SoftwareCompetition, Set)}</li>
 ...
 *          </ul>
 *
 *          Version 3.6 (TOPCODER DIRECT - FIXES FOR CLOSE PRIVATE CHALLENGE
 *          IMMEDIATELY)
 *          <ul>
 *          <li>Refactor
 *          {@link #createReviewerResource(long, long, long, boolean, boolean)}</li>
 *          <li>Fix {@link #closeSoftwareContest(TCSubject, long, long)} to work
 *          with auto pilot</li>
 *          </ul>
 *
 ...
 *          </ul>
 *
 *          Version 3.8 (Topcoder - Ability To Set End Date For Registration
 *          Phase and Submission Phase)
 *          <ul>
 *          <li>Added new createSoftwareContest and updateSoftwareContest
 *          methods to take an extra regEndDate argument</li>
 *          <li>Updated the other methods to call the two methods above</li>
 *          </ul>
 *
 *          Version 3.9(TOPCODER - SUPPORT CUSTOM COPILOT FEE FOR CHALLENGE IN
 *          DIRECT APP):
 *          <ul>
 *          <li>Updated
 *          {@link #updateSoftwareContest(TCSubject, SoftwareCompetition, long, Date, Date)}</li>
 *          <li>Updated
 *          {@link #createSoftwareContest(TCSubject, SoftwareCompetition, long, Date, Date)}</li>
 *          <li>Added
 *          {@link #addManualCopilotPayment(com.topcoder.management.resource.Resource, TCSubject)}</li>
 *          <li>Added
 *          {@link #removeManualCopilotPaymentByResourceId(long, long)}</li>
 ...
 *          <ul>
 *          <li>Added
 *          {@link #purchaseActivateContestAndStartSpecReview(TCSubject, SoftwareCompetition, TCPurhcaseOrderPaymentData, Date, Date, boolean)}</li>
 *          <li>Added
 *          {@link #processContestPurchaseOrderSale(TCSubject, SoftwareCompetition, TCPurhcaseOrderPaymentData, Date, Date, Date)}</li>
 *          <li>Updated
 *          {@link #processContestSaleInternal(TCSubject, SoftwareCompetition, PaymentData, Date, Date, Date)}</li>
 *          </ul>
 *
 *          Version 3.11 (Topcoder - Add Basic Marathon Match Creation And
 *          Update In Direct App):
 *          <ul>
 ...
 *          <ul>
 *          <li>Added method
 *          {@link #isMMContest(com.topcoder.service.project.SoftwareCompetition)}
 *          to check if the contest is of type Marathon Match</li>
 *          <li>Updated method
 *          {@link #createUpdateAssetDTO(com.topcoder.security.TCSubject, com.topcoder.service.project.SoftwareCompetition)}
 *          to set project properties For Marathon Match to allow multiple
 *          submissions.</li>
 *          </ul>
 *
 * @author snow01, pulky, murphydog, waits, BeBetter, hohosky, isv, tangzx,
 *         GreatKevin, lmmortal, minhu, GreatKevin, tangzx, dushyantb
...
public class ContestServiceFacadeBean implements ContestServiceFacadeLocal, ContestServiceFacadeRemote {
  ...
  /**
   * Private contest specifying the notification type of Contest Timeline
   * Notification.
   */
   ...
   * @since 1.2.2
   */
  private static final String CONTEST_ELIGIBILITY_MAPPING_NAMESPACE = "com.topcoder.service.facade.contest.ejb.ContestServiceFacadeBean";
   ...
   * @since 1.6
   */
  private final static List<String> SCHEDULED_STATUS = Arrays.asList("Scheduled", "Specification Submission",
  ...
  /**
   * <p>
   * A <code>ContestEligibilityValidationManager</code> providing access to
   * available <code>Contest Eligibility Validation EJB</code>.
   * </p>
   */
   ...
   * calls to the methods inherited from <code>Category Services</code> component.
   * </p>
   *
   ...
   * calls to the methods inherited from <code>Project Services</code> component.
   * </p>
   *
   * @since TopCoder Service Layer Integration 3 Assembly
   */
   ...
   * <code>Permission Service EJB</code>. This bean is delegated to process the
  ...
  /**
   * <p>
   * A <code>SpecReviewService</code> providing access to available
   * <code>Spec Review Service</code>. This bean is delegated to process the calls
  ...
  /**
   * <p>
   * A <code>ProjectDAO</code> providing access to available billing project
  ...
  /**
   * <p>
   * A <code>ProjectService</code> providing access to project service.
   * </p>
   */
  ...
  /**
   * <p>
   * A <code>PermissionServiceFacade</code> providing access to permission related
   * methods.
   * </p>
   * 
   * @since 1.8
  ...
  /**
   * <p>
   * A <code>SpecificationReviewService</code> providing access to contest
  ...
  /**
   * A flag indicating whether or not create the forum. It's injected, used in the
   * createSoftwareContest method. In the old version, this variable misses the
   * document, it's added in the version 1.1
   */
  private boolean createForum = false;

  /**
   * forumBeanProviderUrl is used in the jndi context to get the forum bean in the
   * createForum method. It's injected, non-null and non-empty after set. In the
   * old version, this variable misses the document, it's added in the version 1.1
   */
  private String softwareForumBeanProviderUrl;

  /**
   * studioForumBeanProviderUrl is used in the jndi context to get the forum bean
   * in the createStudioForum method. It's injected, non-null and non-empty after
   * set.
   *
   * @since 1.6.6
   */
  ...
  /**
   * The root forum category id the studio contest forum is created under. It will
   * be initialized in the method init() by reading the configuration file
   * ContestServiceFacade.xml.
   * 
   * @since 3.1
   */
  ...
  /**
   * <p>
   * A <code>PaymentProcessor</code> instance of payment processor implementing
  ...
  /**
   * userBeanProviderUrl is used in the jndi context to get the user bean. It's
   * injected, non-null and non-empty after set.
   */
  ...
  /**
   * Contains all the contest type ids need custom contest activation email
   * template, the ids are separated with ';' and configured in ejb-jar.xml.
   *
   * @since 1.8.4
   */
  ...
  /**
   * Contains all the custom contest activation email template paths, map to the
   * ids configured in <code>customActivateContestReceiptContestTypeIds</code>.
  ...
  /**
   * The helper map stores the mapping of contest type id to custom contset
   * activation email template path. It's initialized in the init() method.
   *
   * @since 1.8.4
   */
   ...
   *                          etc at initialization time, if this fails it is
   *                          thrown as exception.
   */
  ...
  /**
   * <p>
   * This initializes the API Profile to the <code>CallerServices</code>. The API
   ...
   *
   * <p>
   * Updated in version 1.8.4: - Add the codes to load custom contest type id -
   * custom contest acativation email template path mapping from the ejb
   * configuration.
   * </p>
   *
   * @throws IllegalStateException it throws this exception on any issues during
   *                               caller services initialization. Issues can be:
   *                               wrong authentication information, invalid
   *                               information etc.
   */
  @PostConstruct
  public void init() {
    ...
    try {
      Property payflowProPaymentProcessorProp = configManager.getPropertyObject(DEFAULT_NAMESAPCE,
      ...
      paymentProcessor = new PayflowProPaymentProcessor(payFlowHostAddress, payFlowUser, payFlowPartner, payFlowVendor,
          payFlowPassword);
    ...
    try {
      ...
      studioForumRootCategoryId = Long
          .parseLong(configManager.getString(DEFAULT_NAMESAPCE, "studioForumRootCategoryId"));
    ...
    try {
      ObjectFactory objectFactory = new ObjectFactory(
          new ConfigManagerSpecificationFactory(this.objectFactoryConfigManagerSpecName));
    ...
    if (customActivateContestReceiptContestTypeIds != null
      ...
      if (ids.length != paths.length) {
        throw new IllegalStateException("The configuration of customActivateContestReceiptContestTypeIds"
    ...
    try {
      Property contestSNSProp = configManager.getPropertyObject(DEFAULT_NAMESAPCE, "contestCreationSNS");
   ...
   * @throws ConfigurationException if any error during instance creation.
   *
   * @since Cockpit Release Assembly for Receipts
   */
  private DocumentGenerator getDocumentGenerator() throws ConfigurationException {
    try {
   ...
   *         calendar or <code>null</code> if specified <code>calendar</code> is
   *         <code>null</code>.
   */
   ...
   * @return a <code>XMLGregorianCalendar</code> providing the converted value of
   *         specified date or <code>null</code> if specified <code>date</code> is
   *         <code>null</code> or if it can't be converted to calendar.
   */
   ...
   * </p>
   * 
   * @param tcSubject   TCSubject instance contains the login security info for
   *                    the current user
   * @param competition data that recognizes a contest.
   * @param paymentData payment information (credit card/po details) that need to
   *                    be processed.
   ...
   * @param competition       data that recognizes a contest.
   * @param paymentData       payment information (credit card/po details) that
  ...
  /**
   * <p>
   * Processes the contest sale, activate the contest and start the specification
   ...
   *                           for the current user
   * @param competition        data that recognizes a contest.
   * @param paymentData        payment information (TCSubject tcSubject,credit
   *                           card/po details) that need to be processed.
   * @param multiRoundEndDate  the end date for the multiround phase. No
   *                           multiround if it's null.
   * @param endDate            the end date for submission phase. Can be null if
   *                           to use default.
  ...
  public SoftwareContestPaymentResult purchaseActivateContestAndStartSpecReview(TCSubject tcSubject,
    ...
    final Set<com.topcoder.project.phases.Phase> allPhases = softwareContestPaymentResult.getSoftwareCompetition()
        .getProjectPhases().getPhases();
    ...
    if (hasSpecReview) {
      // only schedule the spec review if the contest has spec submission / spec
      // review
   ...
   * </p>
   * <p>
   * Updated for Version 1.0.3 - For software contest, payment is made for the sum
   * of various costs. - While doing so, only the increased amount is paid (if
   ...
   *
   * <p>
   * Updates in 1.8.4: - Check the DR flag before adding DR points to the total
   * cost - Fix the total member cost and total cost, they should be different.
   * Total cost = total member cost + admin fee - Add the logics to dynamic load
   * activation email tempalte according to the contest type
   * </p>
   *
   *
   * @param tcSubject         TCSubject instance contains the login security info
  ...
  private SoftwareContestPaymentResult processContestSaleInternal(TCSubject tcSubject, SoftwareCompetition competition,
    ...
    try {
      ...
      if (tobeUpdatedCompetition == null) {
        tobeUpdatedCompetition = createSoftwareContest(tcSubject, competition,
            competition.getProjectHeader().getTcDirectProjectId(), regEndDate, multiRoundEndDate, endDate);
        competition.getProjectHeader().setProjectStatus(ProjectStatus.ACTIVE);
      } else {
        competition.setProjectHeaderReason("User Update");
        competition.getProjectHeader().setProjectStatus(ProjectStatus.ACTIVE);
        tobeUpdatedCompetition = updateSoftwareContest(tcSubject, competition,
            competition.getProjectHeader().getTcDirectProjectId(), regEndDate, multiRoundEndDate, endDate);
      }
      ...
      if (competition.getProjectHeader().getProjectCategory().getProjectType().getId() != ProjectType.STUDIO.getId()) {
        ...
        if (contest.getProperty(ProjectPropertyType.FIRST_PLACE_COST_PROJECT_PROPERTY_KEY) != null
          ...
          totalFee += Double
              .parseDouble(contest.getProperty(ProjectPropertyType.FIRST_PLACE_COST_PROJECT_PROPERTY_KEY));
        }
        ...
        if (contest.getProperty(ProjectPropertyType.SECOND_PLACE_COST_PROJECT_PROPERTY_KEY) != null
          ...
          totalFee += Double
              .parseDouble(contest.getProperty(ProjectPropertyType.SECOND_PLACE_COST_PROJECT_PROPERTY_KEY));
        }
        ...
        if (contest.getProperty(ProjectPropertyType.CHECKPOINT_BONUS_COST_PROJECT_PROPERTY_KEY) != null
          ...
          totalFee += Double
              .parseDouble(contest.getProperty(ProjectPropertyType.CHECKPOINT_BONUS_COST_PROJECT_PROPERTY_KEY));
        }
        ...
        if (contest.getProperty(ProjectPropertyType.SPEC_REVIEW_COSTS_PROJECT_PROPERTY_KEY) != null
          ...
          totalFee += Double
              .parseDouble(contest.getProperty(ProjectPropertyType.SPEC_REVIEW_COSTS_PROJECT_PROPERTY_KEY));
        }
        ...
        if (contest.getProperty(ProjectPropertyType.RELIABILITY_BONUS_COST_PROJECT_PROPERTY_KEY) != null
          ...
          totalFee += Double
              .parseDouble(contest.getProperty(ProjectPropertyType.RELIABILITY_BONUS_COST_PROJECT_PROPERTY_KEY));
        }

        // checkpoint prizes
        if (competition.getProjectHeader().getPrizes() != null
            && competition.getProjectHeader().getPrizes().size() > 0) {
      ...
      boolean isDevContest = competition.getProjectHeader().getProjectCategory().getId() == ProjectCategory.DEVELOPMENT
          .getId();

      boolean hasEligibility = contestEligibilityManager
          .haveEligibility(new Long[] { tobeUpdatedCompetition.getProjectHeader().getId() }, false).size() > 0;

      // if creating contest, eligiblity is not commited, so above will not get back
      // result
      if (getBillingProjectId(tobeUpdatedCompetition) != 0 && competition.getProjectHeader().getSecurityGroupId() > 0) {
        hasEligibility = true;
      }
      ...
      toBeUpdatedContest.setProperty(ProjectPropertyType.HISTORICAL_PROJECTED_COST_PROPERTY_KEY,
          Double.toString(totalCost));
      toBeUpdatedContest.setProperty(ProjectPropertyType.PROJECT_ACTIVATE_DATE_PROPERTY_KEY,
          DATE_FORMAT.format(new Date()));
      projectManager.updateProject(toBeUpdatedContest, "Set 'Historical Projected Cost' and 'Project Activate Date'",
          String.valueOf(tcSubject.getUserId()));

      sendActivateContestReceiptEmail(toAddr, purchasedByUser, paymentData, competitionType, competitionTypeId,
          tobeUpdatedCompetition.getProjectHeader().getProperty(ProjectPropertyType.PROJECT_NAME_PROJECT_PROPERTY_KEY),
          projectName, competition.getAssetDTO().getProductionDate().toGregorianCalendar().getTime(), totalMemberCost,
          totalCost, result.getReferenceNumber(), hasContestSaleData, contestIndicator, isStudio(competition),
          competition.getProjectHeader().getId());

      // publish event to AWS SNS if needed
      try {
        String cmcTaskId = competition.getProjectHeader()
            .getProperty(ProjectPropertyType.CLOUDSPOKES_CMC_TASK_PROPERTY_KEY);
        String apiURL = "";

        if (isStudio(competition)) {
          apiURL = "http://api.topcoder.com/v2/design/challenges/"
              + String.valueOf(competition.getProjectHeader().getId());
        } else {
          apiURL = "http://api.topcoder.com/v2/develop/challenges/"
              + String.valueOf(competition.getProjectHeader().getId());
        }
        ...
        if (StringUtils.isNotEmpty(cmcTaskId)) {
          String contestCreationMessage = contestCreationMessageTemplate
              ...
              .replace("%CMC_TASK_ID%", cmcTaskId).replace("%API_URL%", apiURL);

          String subject = contestCreationSubject.replace("%CMC_TASK_ID%", cmcTaskId);

          PublishRequest request = new PublishRequest().withSubject(subject).withMessage(contestCreationMessage)
              .withTopicArn(contestCreationArn);

          PublishResult snsResult = amazonSNSClient.publish(request);
          logger.debug("Publish amazon SNS successfully, the published message id is " + snsResult.getMessageId());
        }
      } catch (Exception e) {
   ...
   *                  current user
   * @return a list containing all active <code>Categories</code>. It can be empty
   *         if no objects found.
   * @throws ContestServiceException if an error occurs when interacting with the
   *                                 service layer.
   * @since TopCoder Service Layer Integration 3 Assembly
  ...
  /**
   * <p>
   * This method finds all tc direct projects. Returns empty array if no projects
   * found.
   * </p>
   * <p>
   * Update in v1.5.1: add parameter TCSubject which contains the security info
  ...
  /**
   * <p>
   * This method finds all given user tc direct projects . Returns empty array if
   * no projects found.
   * </p>
   * <p>
   * Update in v1.5.1: add parameter TCSubject which contains the security info
  ...
  /**
   * Checks the permission for the given tc-direct-project-id for the current
   * caller.
   *
   * @param tcSubject         the current caller
   * @param tcDirectProjectId the project id
   * @param readOnly          true to check READ permission, false to check WRITE
   *                          permission
   * @throws PermissionServiceException if user(not admin) does not have the
   *                                    permission
   */
  ...
  /**
   * Checks the group permission for the given tc-direct-project-id for the
   * current caller.
   *
   * @param tcSubject         the current caller
   * @param tcDirectProjectId the project id
   * @param readOnly          true to check READ permission, false to check WRITE
   *                          permission
   * @throws PermissionServiceException if user(not admin) does not have the group
   *                                    permission
   * @since 1.8.4
   */
  private void checkGroupPermissionForProject(TCSubject tcSubject, long tcDirectProjectId, boolean readOnly)
    ...
    try {
      ...
      if (isCustomerAdministrator) {
        ...
        // If not then check if user is granted desired permission to access the project
        // based on
        // security groups which user is member of
        GroupPermissionType groupPermissionType = authorizationService.checkAuthorization(userId, tcDirectProjectId,
  ...
  /**
   * Checks the billing project permission of the given contest for the current
   * caller.
   *
   * @param contest the contest to check
   * @return billing project id, if it is -1, then no billing project
   * @throws ContestServiceException if user(not admin) does not have the
   *                                 permission
   */
  private void checkBillingProjectPermission(TCSubject tcSubject, SoftwareCompetition contest)
    ...
    if (!isRole(tcSubject, ADMIN_ROLE) && !isRole(tcSubject, TC_STAFF_ROLE)) {
      String billingProject = contest.getProjectHeader()
          .getProperty(ProjectPropertyType.BILLING_PROJECT_PROJECT_PROPERTY_KEY);
  ...
  private void checkContestBillingAccount(long billingAccountId, long directProjectId)
    ...
    final List<com.topcoder.clients.model.Project> billings = projectService
        .getBillingAccountsByProject(directProjectId);
    ...
    try {
      ...
      for (com.topcoder.management.resource.Resource r : contest.getProjectResources()) {
        ...
        if (roleId != ResourceRole.RESOURCE_ROLE_OBSERVER_ID || addNotification) {
          ...
          projectServices.addNotifications(uid, new long[] { projectData.getProjectHeader().getId() },
              String.valueOf(tcSubject.getUserId()));
        }
      }
      ...
      // set timeline notification
      projectServices.addNotifications(tcSubject.getUserId(), new long[] { projectData.getProjectHeader().getId() },
          String.valueOf(tcSubject.getUserId()));
      ...
      if (contest.getDirectProjectMilestoneId() > 0) {
        projectServices.createProjectMilestoneRelation(contest.getProjectHeader().getId(),
            contest.getDirectProjectMilestoneId(), String.valueOf(tcSubject.getUserId()));
      }

      // publish event to AWS SNS if needed
      try {
        String cmcTaskId = contest.getProjectHeader()
            .getProperty(ProjectPropertyType.CLOUDSPOKES_CMC_TASK_PROPERTY_KEY);
        String apiURL = "";
        ...
        if (isStudio(contest)) {
          ...
          apiURL = "http://api.topcoder.com/v2/develop/challenges/"
              + String.valueOf(contest.getProjectHeader().getId());
        }
        ...
        if (StringUtils.isNotEmpty(cmcTaskId)) {
          ...
          logger.debug("Publish amazon SNS successfully, the published message id is " + result.getMessageId());
        }
      } catch (Exception e) {
        // we will only log publish error here, won't rollback contest creation.
        logger.error("Operation failed in publish amazon SNS.", e);
  ...
  private boolean shouldAutoCreateBugHuntContest(SoftwareCompetition contest) {
    return contest.getBugHuntProjectHeader() != null && contest.getBugHuntProjectHeader().getProperties() != null
        && contest.getBugHuntProjectHeader().getProperties().size() != 0;
  }

  /**
   * Create or updating the AssetDTO for the contest. If the AssetDTO already
   * exists for development contest, we need to create dev-component. Also,
   * creating forum if necessary.
   * <p>
   * Update in v1.5.1: add parameter TCSubject which contains the security info
   * for current user.
   * </p>
   * <p>
   * Update in v1.6.4: set digital run flag to 'Off' and rated to 'No' if it's
   * copilot selection contest.
   * </p>
   *
   * <p>
   * Update in 1.8.3: - Reuse the same assetDTO as the parent contest for auto
   * creation bug hunt contest.
   * </p>
   *
   * @param tcSubject TCSubject instance contains the login security info for the
   *                  current user
  ...
  private void createUpdateAssetDTO(TCSubject tcSubject, SoftwareCompetition contest) throws EntityNotFoundException,
    ...
    if (contest.getAssetDTO() != null) {
      ...
      contest.getProjectHeader().setProperty(ProjectPropertyType.EXTERNAL_REFERENCE_ID_PROJECT_PROPERTY_KEY,
          assetDTO.getCompVersionId().toString());
      contest.getProjectHeader().setProperty(ProjectPropertyType.COMPONENT_ID_PROJECT_PROPERTY_KEY,
          assetDTO.getId().toString());
      contest.getProjectHeader().setProperty(ProjectPropertyType.ROOT_CATALOG_ID_PROJECT_PROPERTY_KEY,
          assetDTO.getRootCategory().getId().toString());
      ...
      // if creating contest, eligiblity is not commited, so above will not get back
      // result
      if (billingProjectId != 0 && contest.getProjectHeader().getSecurityGroupId() > 0) {
        hasEligibility = true;
      }
      ...
      if (!isStudio(contest) && !isCopilotContest(contest)
          && contest.getProjectHeader().getProjectCategory().getId() != ProjectCategory.BUG_HUNT.getId()
          && !isCodeContest(contest) && !isF2FContest(contest)) {
  ...
  /**
   * <p>
   * If the auto creating development contest is switch on, we need to prepare the
   * contest here.
   * </p>
   * <p>
   * Update in v1.5.1: add parameter TCSubject which contains the security info
  ...
  private void autoCreateDevContest(TCSubject tcSubject, SoftwareCompetition designContest, long tcDirectProjectId,
      SoftwareCompetition devContest)
      throws DatatypeConfigurationException, ContestServiceException, PermissionServiceException {
  ...
  /**
   * <p>
   * Auto creates the bug hunt contest for the parent contest if auto create bug
   * hunt is on. This method prepares the bug hunt contest before inserting into
   * the persistence.
   * </p>
   *
   * @param tcSubject         instance contains the login security info for the
   *                          current user
   ...
   * @throws ContestServiceException    if any error occurs realted to Contest
   *                                    Service facade
   * @throws PermissionServiceException if any error occurs to Permission service
   *                                    facade
   * @since 1.8.3
   */
  private void autoCreateBugHuntContest(TCSubject tcSubject, SoftwareCompetition assemblyContest,
      long tcDirectProjectId, SoftwareCompetition bugHuntContest, Date bugHuntStartTime)
      throws ContestServiceException, PermissionServiceException {
  ...
  /**
   * <p>
   * Persists the GroupContestEligibility for the contest and client. If the
   * eligiblity is not null, then the information will be copied from it.
   * </p>
   * 
  ...
  /**
   * <p>
   * Adding the contest resources when creating contest. manager or observer or
   * client-manager will be added.
   * </p>
   * <p>
   * Update in v1.5.1: add parameter TCSubject which contains the security info
   * for current user.
   * </p>
   * <p>
   * Update in v1.6.8: gets the copilot resource from getResources() of
   * SoftwareCompetition.
   * </p>
   *
   * <p>
   * Update in v1.8.3: For auto created bug hunt contest, insert the copilot as
   * reviewer of the bug hunt contest if the copilot exists.
   * </p>
   *
   * @param tcSubject        TCSubject instance contains the login security info
   *                         for the current user
  ...
  private com.topcoder.management.resource.Resource[] createContestResources(TCSubject tcSubject,
      SoftwareCompetition contest, long billingProjectId, boolean requireApproval)
      throws ContestServiceException, UserServiceException, PermissionServiceException {
    ...
    if (contestResources.length > 1) {
      for (int i = 1; i < contestResources.length; ++i) {
        ...
        if (contestResources[i].getResourceRole().getId() == ResourceRole.RESOURCE_ROLE_COPILOT_ID) {
          ...
          if (appirioManager.getProperty(RESOURCE_INFO_EXTERNAL_REFERENCE_ID)
              .equals(String.valueOf(tcSubject.getUserId()))) {
    ...
    // create an array to store the resources, if copilot exists and copilot is not
    // current user, we create
     ...
     * billingProjectId).trim();
     * 
     * if (adminRole.length() > 0) { long roleId = userService.getUserId(adminRole);
     ...
     * resources[1].setProperty(RESOURCE_INFO_REGISTRATION_DATE,
     * DATE_FORMAT.format(new Date())); } }
     **/
    ...
    if (copilot != null && (!isCopilotCurrentUser || appirioManager != null)) {
      ...
      // when copilot exists and copilot is not current user, we store resource in
    ...
    List<Permission> permissions = this.permissionService
        .getPermissionsByProject(contest.getProjectHeader().getTcDirectProjectId());
    ...
    if (contest.getProjectHeader().getAutoAssignReviewerId() > 0) {
      if (contest.getProjectHeader().getProjectCategory().getId() == ProjectCategory.FIRST2FINISH.getId()) {
        allResources.add(createIterativeReviewerResource(contest.getProjectHeader().getAutoAssignReviewerId(), 0, 0));
      }
    }
   ...
   * @since 2.5
   */
  private com.topcoder.management.resource.Resource createIterativeReviewerResource(long userId, long contestId,
      long phaseId) throws UserServiceException {
  ...
  /**
   * Creates the approver contest resource with the same information from the
   * provided copilot contest resource.
   *
   ...
   * @since 1.9.2
   */
  private com.topcoder.management.resource.Resource createApproverResourceFromCopilot(
      com.topcoder.management.resource.Resource copilot, long projectId) {
    com.topcoder.management.resource.Resource r = new com.topcoder.management.resource.Resource();
    // approval role
    ...
    r.setProperty(RESOURCE_INFO_EXTERNAL_REFERENCE_ID,
        copilot.getProperties().get(RESOURCE_INFO_EXTERNAL_REFERENCE_ID));
  ...
  /**
   * Deletes the specified contest, it marks the contest status to "Deleted". User
   * can only delete the contests with status:Draft. If the contest is not draft,
   * it won't be deleted.
   *
  ...
  public List<SoftwareCompetition> deleteSoftwareContests(TCSubject tcSubject, long tcDirectProjectId,
      List<Long> softwareContestIds) throws ContestServiceException, PermissionServiceException {

    logger.debug(
        "deleteSoftwareContests with information : [tcSubject = " + tcSubject.getUserId() + ", tcDirectProjectId ="
    ...
    try {
      ...
      for (SoftwareCompetition contest : softwareContests) {
        ...
        // if the contest to delete is draft, mark it as status deleted. Do not delete
        // non-draft contests
        if (contest.getProjectHeader().getProjectStatus().getId() == CONTEST_DRAFT_STATUS_ID) {
          ...
          contest.setProjectHeaderReason("User:" + tcSubject.getUserId()
              + " deletes the contest via batch edit for direct project:" + tcDirectProjectId);
  ...
  /**
   * Updates all the passed in draft <code>SoftwareCompetition</code> in one
   * trasaction. If there is <code>SoftwareCompetition</code> not in draft status,
   * it won't be updated.
   *
   * @param tcSubject         the tcSubject instance.
   * @param tcDirectProjectId the id of the tc direct project.
   * @param draftContests     a list of <code>SoftwareCompetition</code> to
   *                          update.
  ...
  public List<SoftwareCompetition> batchUpdateDraftSoftwareContests(TCSubject tcSubject, long tcDirectProjectId,
      List<SoftwareCompetition> draftContests) throws ContestServiceException, PermissionServiceException {

    logger.debug("batchUpdateDraftSoftwareContests with information : [tcSubject = " + tcSubject.getUserId()
        + ", tcDirectProjectId =" + tcDirectProjectId + ", draftContests size: = " + draftContests.size() + "]");
   ...
   * @param tcSubject         TCSubject instance contains the login security info
   *                          for the current user
   * @param contest           the <code>SoftwareCompetition</code> to update as a
   *                          contest
   ...
   *
   * <p>
   * Update in 1.9.2: Update to support add copilot as the approver of the contest
   * when updating the contest.
   * </p>
   *
   * @param tcSubject         TCSubject instance contains the login security info
   *                          for the current user
  ...
  public SoftwareCompetition updateSoftwareContest(TCSubject tcSubject, SoftwareCompetition contest,
    ...
    try {
      ...
      if (contest.getProjectHeader() != null) {
        ...
        com.topcoder.project.phases.Phase[] phases = phaseset
            .toArray(new com.topcoder.project.phases.Phase[phaseset.size()]);
        ...
        for (com.topcoder.management.resource.Resource r : contest.getProjectResources()) {
          if (r.getResourceRole().getId() == ResourceRole.RESOURCE_ROLE_COPILOT_ID) {
            ...
            for (com.topcoder.management.resource.Resource oldApprover : oldApprovers) {
              if (oldApprover.getProperties().get(RESOURCE_INFO_EXTERNAL_REFERENCE_ID)
                  .equals(r.getProperties().get(RESOURCE_INFO_EXTERNAL_REFERENCE_ID))) {
          ...
          if (r.getResourceRole().getId() == ResourceRole.RESOURCE_ROLE_APPROVER_ID) {
            ...
            for (com.topcoder.management.resource.Resource oldCopilot : oldCopilots) {
              if (oldCopilot.getProperties().get(RESOURCE_INFO_EXTERNAL_REFERENCE_ID)
                  .equals(r.getProperties().get(RESOURCE_INFO_EXTERNAL_REFERENCE_ID))) {
            ...
            if (needApproverRemoved
                && !updatedCopilots.contains(r.getProperties().get(RESOURCE_INFO_EXTERNAL_REFERENCE_ID))) {
              continue;
            }
          }
        ...
        if (isF2FContest(contest)) {
          ...
          com.topcoder.management.resource.Resource[] oldReviewers = projectServices
              .searchResources(contest.getProjectHeader().getId(), ResourceRole.RESOURCE_ROLE_ITERATIVE_REVIEWER_ID);

          if (oldReviewers != null && oldReviewers.length == 0
              && contest.getProjectHeader().getAutoAssignReviewerId() > 0) {
            // no reviewers added and has auto reviewer id > 0 set, auto add iterative
            // reviewer
            ...
            if (iterativeReviewPhase != null) {
              updatedResources.add(createIterativeReviewerResource(contest.getProjectHeader().getAutoAssignReviewerId(),
                  contest.getProjectHeader().getId(), iterativeReviewPhase.getId()));
            }
          }
          ...
          com.topcoder.management.resource.Resource[] oldReviewers = projectServices
              .searchResources(contest.getProjectHeader().getId(), ResourceRole.RESOURCE_ROLE_REVIEWER_ID);
          ...
          if (oldReviewers != null && oldReviewers.length == 0
            ...
            if (reviewPhase != null) {
              // no reviewers added and has auto reviewer id > 0 set, auto add reviewer
              // without any payment

              updatedResources.add(createReviewerResource(contest.getProjectHeader().getAutoAssignReviewerId(),
                  contest.getProjectHeader().getId(), reviewPhase.getId(), false));

              // no review payment
              contest.getProjectHeader().setProperty(ProjectPropertyType.REVIEW_COSTS_PROJECT_PROPERTY_KEY, "0");
        ...
        FullProjectData projectData = projectServices.updateProject(contest.getProjectHeader(),
            contest.getProjectHeaderReason(), contest.getProjectPhases(),
            updatedResources.toArray(new com.topcoder.management.resource.Resource[updatedResources.size()]),
            regEndDate, multiRoundEndDate, endDate, String.valueOf(tcSubject.getUserId()));
        ...
        boolean forumTypeExists = oldProjectData.getProjectHeader().getAllProperties()
        ...
        if (forumId > 0 && createForum && !isStudio(contest)) {
          ...
          for (com.topcoder.management.resource.Resource r : oldCopilots) {
            deleteSoftwareForumWatchAndRole(forumId,
                Long.parseLong(r.getProperty(RESOURCE_INFO_EXTERNAL_REFERENCE_ID)));
          }
        ...
        // NOTE. comment out because now all challenges can set its groups, regards of
        // its billing id status
        // keep as reference
        //
        ...
        // contestEligibilityManager.getContestEligibility(contest.getProjectHeader().getId(),
        // false);
      ...
      long directProjectMilestoneId = projectServices.getProjectMilestoneRelation(contest.getProjectHeader().getId());
      ...
      try {
        ...
        if (StringUtils.isNotEmpty(cmcTaskId)
            && (oldCMCTaskId == null || (oldStartDate != null && startDate != null && !oldStartDate.equals(startDate))
        ...
        if (StringUtils.isNotEmpty(oldCMCTaskId) && StringUtils.isNotEmpty(cmcTaskId)
          ...
          // the old and new cmc Task id are not empty && the task ID is changed, sent
          // change notification
          // update from none -> CMC Task ID, sent creation notification
          String contestUpdateMessage = contestUpdateMessageTemplate
              .replace("%CHALLENGE_ID%", String.valueOf(contest.getProjectHeader().getId()))
              .replace("%CMC_TASK_ID%", cmcTaskId).replace("%OLD_CMC_TASK_ID%", oldCMCTaskId)
              .replace("%API_URL%", apiURL);

          String subject = contestUpdateSubject.replace("%CMC_TASK_ID%", cmcTaskId);

          PublishRequest request = new PublishRequest().withSubject(subject).withMessage(contestUpdateMessage)
              .withTopicArn(contestCreationArn);
   ...
   * @since 3.3
   */
  public Set<Long> updatePreRegister(TCSubject tcSubject, SoftwareCompetition contest, Set<Long> preRegisterMembers)
      throws ContestServiceException {
    long forumId;
    String userRoleId = "";
  ...
  /**
   * <p>
   * Updates contest observer resources from direct project if the direct project
   * associated is changed.
   * </p>
   *
   ...
   */
  private void updateContestObserversFromDirectProject(TCSubject tcSubject, SoftwareCompetition contest)
      throws Exception {
    long forumId = projectServices.getForumId(contest.getId());

    // Remove all current observers
    for (com.topcoder.management.resource.Resource resource : this.projectServices.searchResources(contest.getId(),
        ResourceRole.RESOURCE_ROLE_OBSERVER_ID)) {
   ...
   * @throws IllegalArgumentException if any id is &lt; 0, if any argument is
   *                                  <code>null</code> or trim to empty
   * @throws ContestServiceException  if an error occurs when interacting with the
   *                                  service layer.
   * @since TopCoder Service Layer Integration 3 Assembly
   */
  ...
  public long uploadSubmission(long userId, long projectId, String filename, DataHandler submission)
    ...
    try {
      ...
      return uploadExternalServices.uploadSubmission(projectId, userId, filename, submission);
   ...
   * @throws IllegalArgumentException if any id is &lt; 0 or if operator is null
   *                                  or trim to empty
   * @throws ContestServiceException  if an error occurs when interacting with the
   *                                  service layer.
   * @since TopCoder Service Layer Integration 3 Assembly
  ...
  /**
   * Create studio forum with given parameters. It will lookup the ForumsHome
   * interface, and create the studio forum by the ejb home interface.
   *
  ...
  /**
   * create forum with given parameters. It will lookup the ForumsHome interface,
   * and ceate the forum by the ejb home interface. In the old version, this
   * method misses the document, it's added in the version 1.1
   *
  ...
  public long createForum(TCSubject tcSubject, AssetDTO asset, long userId, long projectCategoryId) {
    ...
    try {
      ...
      forumId = forums.createSoftwareComponentForums(asset.getName(), asset.getId(), asset.getCompVersionId(), phaseId,
          Status.REQUESTED.getStatusId(), asset.getRootCategory().getId(), asset.getShortDescription(),
      ...
      logger.error("Created forum " + forumId + " for " + asset.getName());
  ...
  public List<CommonProjectContestData> getCommonProjectContestDataByPID(TCSubject tcSubject, long pid) {
    ...
    for (com.topcoder.management.project.SimpleProjectContestData data : projectServices
        .getSimpleProjectContestData(pid)) {
   ...
   * </p>
   * <p>
   * Updated for v1.6 Direct Search Assembly - provided contest fee for each
   * contest data
   * </p>
   *
   * @param tcSubject TCSubject instance contains the login security info for the
  ...
  public List<CommonProjectContestData> getCommonProjectContestData(TCSubject tcSubject) {
    ...
    for (com.topcoder.management.project.SimpleProjectContestData data : projectServices
        .getSimpleProjectContestData(tcSubject)) {
      CommonProjectContestData newData = new CommonProjectContestData();
      newData.setCname(data.getCname());
      newData.setContestId(data.getContestId());
      newData.setProjectId(data.getProjectId());
  ...
  /**
   * Gets all project data with aggregated statistics data for each type of
   * contest status.
   *
   * <p>
   ...
   *
   * <p>
   * Version 1.7.5 - set project creation date into the ProjectSummaryData
   * returned
   * </p>
   *
  ...
  /**
   * <p>
   * BURG-1716: We need to add a method to get software contest by project id, the
   * method wil get all OR project related data, then from project property to get
   * comp version id then to call getAssetByVersionId to get assetDTO, please
   * check create software contest to see what data need to be returned.
   * </p>
   * <p>
   * Update in v1.5.1: add parameter TCSubject which contains the security info
   * for current user.
  ...
  public SoftwareCompetition getSoftwareContestByProjectId(TCSubject tcSubject, long projectId)
    ...
    try {
      ...
      contest
          .setDirectProjectMilestoneId(projectServices.getProjectMilestoneRelation(contest.getProjectHeader().getId()));

      // get the security group id if there is any
      List<ContestEligibility> contestEligibilities = contestEligibilityManager
          .getContestEligibility(contest.getProjectHeader().getId(), false);
      ...
      if (contestEligibilities != null && contestEligibilities.size() > 0 && contestEligibilities.get(0) != null
        ...
        contest.getProjectHeader()
            .setSecurityGroupId(((GroupContestEligibility) contestEligibilities.get(0)).getGroupId());
      }
      // end remove
      ...
      logger.error("the properites 'Version ID' is not of Long value in project.", nfe);
      sessionContext.setRollbackOnly();
  ...
  /**
   * <p>
   * Sends the email for specified template to specified to, cc, bcc address from
   * specified from address.
   * </p>
   *
   ...
   * @throws EmailMessageGenerationException thrown if error during email
   *                                         generation
   * @throws EmailSendingException           thrown if error during email sending.
   *
   * @since Cockpit Release Assembly for Receipts.
   */
  private void sendEmail(String templateSource, String templateName, String subject, String[] toAddrs, String ccAddr,
      String bccAddr, String fromAddr, com.topcoder.project.phases.Phase phase)
    ...
    try {
      ...
      Template template = (templateSource == null) ? documentGenerator.getTemplate(templateName)
      ...
      logger.debug("Generated following email message of subject [" + subject + "] to be sent to [" + fromAddr + "] \n"
          + messageBody);
      ...
      logger.debug("Sent email message of subject [" + subject + "] to [" + fromAddr + "]");
   ...
   *
   * <p>
   * If given <code>messageGenerated</code> is false, then this error occurs while
   ...
   * @param messageGenerated Indicates whether the email message has been
   *                         generated successfully.
   *
   * @param phase
   * @throws EmailMessageGenerationException If <code>messageGenerated</code> is
   *                                         false.
   * @throws EmailSendingException           If <code>messageGenerated</code> is
   *                                         true.
   *
   * @since Cockpit Release Assembly for Receipts.
   */
   ...
   * email template from the passed in <code>competitionTypeId</code>
   * </p>
   *
   *
   * @param toAddr            the to address for email send.
   * @param purchasedBy       the name of the person who purchased.
   * @param paymentData       the payment data. it is one of
   *                          TCPurhcaseOrderPaymentData or CreditCardPaymentData
   * @param competitionType   the competition type, person activated.
   * @param competitionTypeId the competition type id.
   ...
   * @param contestIndicator  an indicator represents how winner selection will
   *                          occur.
   *
   * @throws EmailMessageGenerationException throws if error during email message
   *                                         generation
  ...
  private void sendActivateContestReceiptEmail(String toAddr, String purchasedBy, PaymentData paymentData,
      String competitionType, long competitionTypeId, String competitionTitle, String projectName, Date launchTime,
      Double price, Double totalCost, String orderNumber, boolean hasContestSaleData, String contestIndicator,
      boolean isDesign, long challengeId) throws EmailMessageGenerationException, EmailSendingException {
    ...
    // check if there custom email template path configured for the
    // competitionTypeId
    ...
    String file = Thread.currentThread().getContextClassLoader().getResource(templateToUse).getFile();
    Logger.getLogger(this.getClass()).debug("File name for template: " + file);

    sendEmail(EMAIL_FILE_TEMPLATE_SOURCE_KEY, file,
        activateContestReceiptEmailSubject.replace("%ORDER_NUMBER%", orderNumber), new String[] { toAddr }, null, null,
        activateContestReceiptEmailFromAddr, phase);
  }

  /**
   * Helper method to send email to copilot posting winner when the winner is
   * chosen as the copilot.
   *
   * @param copilotUserId the user id of the copilot
   * @param project       the direct project
   * @param contest       the copilot posting contest
   * @throws UserServiceException            if fail to get email address of the
   *                                         copilot
   * @throws EmailMessageGenerationException if fail to generate the content of
   *                                         copilot winner email
   * @throws EmailSendingException           i fail to send the copilot winner
   *                                         email
   * @since 1.8.5
   */
  private void sendCopilotWinnerEmail(long copilotUserId, ProjectData project, SoftwareCompetition contest)
    ...
    String file = Thread.currentThread().getContextClassLoader().getResource(copilotWinnerEmailTemplatePath).getFile();
    Logger.getLogger(this.getClass()).debug("File name for template: " + file);

    // send the email
    sendEmail(EMAIL_FILE_TEMPLATE_SOURCE_KEY, file,
        copilotWinnerEmailSubject.replace("%PROJECT_NAME%", project.getName()), new String[] { toAddr }, null,
        copilotWinnerEmailBCCAddr, copilotWinnerEmailFromAddr, phase);
  }
   ...
   * @since Cockpit Release Assembly for Receipts
   */
  private void setReceiptEmailCommonProperties(com.topcoder.project.phases.Phase phase, String purchasedBy,
      PaymentData paymentData, String competitionType, String competitionTitle, String projectName, boolean isDesign,
      long challengeId) {
    ...
    if (paymentData instanceof TCPurhcaseOrderPaymentData) {
      ...
      if (po.getClientName() != null) {
        sb.append("Client Name:")
            .append(po.getClientName().replaceAll("&", "&amp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;"));
      } else {
      ...
      if (po.getProjectName() != null) {
        sb.append("Billing Project Name:")
            .append(po.getProjectName().replaceAll("&", "&amp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;"));
      } else {
    ...
    if (isDesign) {
      phase.setAttribute("COMPETITION_URL", "http://" + ApplicationServer.NEW_COMMUNITY_SERVER_NAME
          + "/challenge-details/" + challengeId + "/?type=design");
    } else {
      phase.setAttribute("COMPETITION_URL", "http://" + ApplicationServer.NEW_COMMUNITY_SERVER_NAME
          + "/challenge-details/" + challengeId + "/?type=develop");
    }
  }
   ...
   *                  current user
   * @param contestId the contest id
   * @param studio    indicates whether the specified contest id is for studio
   *                  contests.
   * @return the spec review that matches the specified contest id.
   * @throws ContestServiceException if any error during retrieval/save from
   *                                 persistence
  ...
  /**
   * Save specified review comment and review status for specified section and
   * specified contest id to persistence.
   * <p>
   * Update in v1.5.1: add parameter TCSubject which contains the security info
   * for current user.
   * </p>
   ...
   * @since Cockpit Launch Contest - Inline Spec Review Part 2
   */
  public void saveReviewStatus(TCSubject tcSubject, long contestId, boolean studio, String sectionName, String comment,
      boolean isPass, String role) throws ContestServiceException {
    try {
  ...
  /**
   * Save specified review comment for specified section and specified contest id
   * to persistence.
   * <p>
   * Update in v1.5.1: add parameter TCSubject which contains the security info
   * for current user.
   ...
   * @since Cockpit Launch Contest - Inline Spec Review Part 2
   */
  public void saveReviewComment(TCSubject tcSubject, long contestId, boolean studio, String sectionName, String comment,
   ...
   * Persistence is updated and all end users having write/full permission on the
   * contest are notified by email.
   * <p>
   * Update in v1.5.1: add parameter TCSubject which contains the security info
   * for current user.
   * </p>
   ...
   * Persistence is updated, on update the spec would appear as review opportunity
   * on tc site.
   * <p>
   * Update in v1.5.1: add parameter TCSubject which contains the security info
   * for current user.
   ...
   *
   * @param toAddrs     array of to addresses to which spec review notification
   *                    email should be sent.
   * @param updates     the data about updated sections.
   * @param contestName the name of the contest
   * @throws EmailMessageGenerationException thrown if error during email message
   *                                         generation
   * @throws EmailSendingException           thrown if error during email sending.
   * @since 1.0.2
   */
  private void sendSpecReviewNotificationEmail(String[] toAddrs, List<UpdatedSpecSectionData> updates,
    ...
    String file = Thread.currentThread().getContextClassLoader().getResource(specReviewNotificationEmailTemplatePath)
        .getFile();
    Logger.getLogger(this.getClass()).debug("File name for template: " + file);
    sendEmail(EMAIL_FILE_TEMPLATE_SOURCE_KEY, file,
        specReviewNotificationEmailSubject.replace("%CONTEST_NAME%", contestName), toAddrs, null,
        specReviewNotificationEmailBCCAddr, specReviewNotificationEmailFromAddr, phase);
  }
   ...
   * @return true if the user is eligible for the specified contest, false
   *         otherwise.
   * @throws ContestServiceException if any other error occurs
   * @since 1.2.2
   */
   ...
   * @since 1.2.3
   *
   *        public String getEligibilityAdminRole(TCSubject tcSubject, long
   *        billingProjectId) { String methodName = "getEligibilityAdminRole :
   *        billing project id = "+ billingProjectId; logger.info("Enter: " +
   *        methodName); try { ConfigManager cfgMgr = ConfigManager.getInstance();
   *        Property rootProperty =
   *        cfgMgr.getPropertyObject(CONTEST_ELIGIBILITY_MAPPING_NAMESPACE,
   *        CONTEST_ELIGIBILITY_MAPPING_PREFIX); Property eligibility =
   *        rootProperty.getProperty(Long.toString(billingProjectId)); if
   *        (eligibility != null && !eligibility.equals("")) {
   * 
   *        return (String)(eligibility.getValue(ELIGIBILITY_ADMIN_ROLE)); }
   *        return ""; } catch (Exception e) { logger.error("Cannot retrieve
   *        eligibility admin role."); return ""; } finally { logger.info("Exit: "
   *        + methodName); } }
   **/

  /**
   * Private helper method to remove loops within documentation collection in
   * AssetDTO
   *
  ...
  /**
   * This method creates a Specification Review project associated to a project
   ...
   * @throws ContestServiceException if any unexpected error occurs in the
   *                                 underlying services
   * @since 1.4
   */
  ...
  /**
   * This method retrieves scorecard and review information associated to a
   * project determined by parameter. Note: a single reviewer / review is assumed.
   * <p>
   * Update in v1.5.1: add parameter TCSubject which contains the security info
   * for current user.
   * </p>
  ...
  /**
   * This method uploads a mock file to the corresponding specification review
   * project of the specified project id, so that it can continue with review.
   * Regular submission or final fix will be uploaded according to the open phase.
   * <p>
   * Update in v1.5.1: add parameter TCSubject which contains the security info
   * for current user.
   * </p>
   ...
   * @throws ContestServiceException if any unexpected error occurs in the
   *                                 underlying services, if the associated
   *                                 specification review project id cannot be
   *                                 found or if neither submission or final fixes
   *                                 phase are open.
   * @since 1.4
   */
  ...
  /**
   * This method adds a review comment to a review. It simply delegates all logic
  ...
  /**
   * create software forum watch with given parameters. It will lookup the
   * ForumsHome interface, and ceate the forum by the ejb home interface. In the
   * old version, this method misses the document, it's added in the version 1.1
   *
   *
   * @param asset             The asset DTO to user
   * @param userId            userId The user id to use
  ...
  /**
   * create stduio forum watch with given parameters. It will lookup the
   * ForumsHome interface, and ceate the forum by the ejb home interface. In the
   * old version, this method misses the document, it's added in the version 1.1
   *
   *
  ...
  /**
   * delete software forum watch with given parameters. It will lookup the
   * ForumsHome interface, and ceate the forum by the ejb home interface. In the
   * old version, this method misses the document, it's added in the version 1.1
   *
   *
   ...
   * interface, and ceate the forum by the ejb home interface. In the old version,
   * this method misses the document, it's added in the version 1.1
   *
   *
   * @param forumId          The forum id to delete watch.
   * @param userId           userId The user id to use
   * @param isNewStudioForum whethether the studio forum is ported to the software
   *                         forum
   */
  ...
  /**
   * check if user agrees the term(s) associate with the project (if any) by role
   *
   * @param projectId OR project id
   * @param userId    userId The user id to use
  ...
  private boolean checkTerms(long projectId, long userId, int[] roleIds) {
    ...
    try {
      ...
      ProjectRoleTermsOfUseHome projectRoleTermsOfUseHome = (ProjectRoleTermsOfUseHome) c2
          .lookup(ProjectRoleTermsOfUseHome.EJB_REF_NAME);
  ...
  /**
   * <p>
   * Create new version for design or development contest. (project_status_id =
   * 4-10 in tcs_catalog:project_status_lu).
   * </p>
   * <p>
   * Update in v1.5.1: add parameter TCSubject which contains the security info
   * for current user.
   ...
   * @param tcDirectProjectId tc direct project id
   * @param autoDevCreating   if it is true and it is design contest, then will
   *                          create development too
  ...
  private long createNewVersionForDesignDevContest(TCSubject tcSubject, long projectId, long tcDirectProjectId,
    ...
    try {
      ...
      if (!autoDevCreating
          && contest.getProjectHeader().getProjectStatus().getId() != ProjectStatus.COMPLETED_STATUS_ID) {
        throw new ProjectServicesException(
            "The design project or its corresponding development project is not completed."
                + " You can not create new version for it.");
      }
      boolean isDevContest = contest.getProjectHeader().getProjectCategory().getId() == ProjectCategory.DEVELOPMENT
          .getId();

      // 2.create new version
      Long compVersionId = Long.parseLong(
          contest.getProjectHeader().getProperty(ProjectPropertyType.EXTERNAL_REFERENCE_ID_PROJECT_PROPERTY_KEY));
      ...
      contest.getProjectHeader().setProperty(ProjectPropertyType.EXTERNAL_REFERENCE_ID_PROJECT_PROPERTY_KEY,
          String.valueOf(dto.getVersionNumber()));
      contest.getProjectHeader().setProperty(ProjectPropertyType.PROJECT_VERSION_PROJECT_PROPERTY_KEY,
          String.valueOf(dto.getVersionText()));
      contest.getProjectHeader().setProperty(ProjectPropertyType.VERSION_ID_PROJECT_PROPERTY_KEY,
      ...
      long forumId = 0;
      // create forum BUGR 4036: only create forum if it is dev only contest when it
      // is dev contest
      ...
      if (createForum && needForum) {
        forumId = createForum(tcSubject, dto, tcSubject.getUserId(),
            contest.getProjectHeader().getProjectCategory().getId());
      }
      ...
      FullProjectData newVersionORProject = projectServices.createNewVersionContest(contest,
          String.valueOf(tcSubject.getUserId()));
      ...
      if (autoDevCreating && !isDevContest) {
        ...
        if (developmentProjectId > 0) {
          ...
          createNewVersionForDesignDevContest(tcSubject, developmentProjectId, tcDirectProjectId, true,
              nextDevProdDay(startDate), minorVersion);
        }
      }

      // BUGR 4036
      if (isDevContest) {
        // it will link to design contest if it exists, it forwards to project link
        // manager
  ...
  public long createNewVersionForDesignDevContest(TCSubject tcSubject, long projectId, long tcDirectProjectId,
    ...
    logger.debug(
        "createNewVersionForDesignDevContest with parameter [TCSubject " + tcSubject.getUserId() + ", projectId ="
  ...
  public long reOpenSoftwareContest(TCSubject tcSubject, long projectId, long tcDirectProjectId)
      throws ContestServiceException, PermissionServiceException {
    logger.debug("reOpenSoftwareContest with parameter [TCSubject " + tcSubject.getUserId() + ", projectId ="
        + projectId + ", tcDirectProjectId =" + tcDirectProjectId + "].");
    ...
    try {
      ...
      if (contest.getProjectHeader().getProjectStatus().getId() != ProjectStatus.CANCELLED_FAILED_REVIEW_ID
          ...
          && contest.getProjectHeader().getProjectStatus().getId() != ProjectStatus.CANCELLED_REQUIREMENTS_INFEASIBLE
              .getId()
          && contest.getProjectHeader().getProjectStatus().getId() != ProjectStatus.CANCELLED_ZERO_REGISTRATIONS
              .getId()) {
      ...
      FullProjectData reOpendedProject = projectServices.createReOpenContest(contest,
          String.valueOf(tcSubject.getUserId()));
  ...
  /**
   * Gets the notification information for the given user id. The notification
   * information will be returned as a list of ProjectNotification instance.
   *
   * @param subject the TCSubject instance.
   * @param userId  the id of the user.
   * @return a list of ProjectNotification instances.
   * @throws ContestServiceExeption if any error occurs, exception from forum EJB
   *                                service will be caught and logged, but no
   *                                thrown out.
  ...
  public List<ProjectNotification> getNotificationsForUser(TCSubject subject, long userId)
      throws ContestServiceException {
    logger
        .info("getNotificationsForUser with arguments [TCSubject " + subject.getUserId() + ", userId =" + userId + "]");
    ...
    try {
      ...
      long[] notifiedContestIds = this.projectServices.getNotificationsForUser(userId, TIMELINE_NOTIFICATION_TYPE,
          contestIds);
  ...
  /**
   * Updates the notifications for the given user, the notifications which need to
   * update are passed in as a list of ProjectNotification instances.
   *
   * @param subject       the TCSubject instance.
   * @param userId        the id of the user.
  ...
  public void updateNotificationsForUser(TCSubject subject, long userId, List<ProjectNotification> notifications)
    ...
    try {
      ...
      this.projectServices.removeNotifications(userId, getPrimitiveArray(allContestIdList),
          String.valueOf(subject.getUserId()));

      // add notifications
      this.projectServices.addNotifications(userId, getPrimitiveArray(notifyContestIdList),
          String.valueOf(subject.getUserId()));
  ...
  /**
   * Generates a string which contains debug info of a list of ProjectNotification
   * instances.
   *
  ...
  /**
   * Gets the registrant information for the given project. If the project is of
   * type Studio, a boolean flag isStudio should be set to true and passed as
   * argument.
   *
   * @param tcSubject the TCSubject instance.
   * @param ProjectId the id of the project.
   ...
   * @since BUGR-3738
   */
  public List<Registrant> getRegistrantsForProject(TCSubject tcSubject, long projectId) throws ContestServiceException {
    ...
    try {
      ...
      // if any exception occurs, log it and wrap into ContestServiceException and
      // throw out
   ...
   * @param reviewerResourceId a <code>long</code> providing the ID for reviewer
   *                           resource.
   * @param submissionId       a <code>long</code> providing the ID for
   *                           submission.
   * @return a <code>ScorecardReviewData</code> providing the details for review
   *         or <code>null</code> if review and scorecard is not found,
   * @since 1.6.5
   */
  ...
  /**
   * <p>
   * Gets the <code>ScorecardReviewData</code> data for a specified submission.
   * </p>
   *
   * @param projectId          a <code>long</code> providing the project ID.
   * @param reviewerResourceId a <code>long</code> providing the ID for reviewer
   ...
   *
   * @param projectId          a <code>long</code> providing the project ID.
   * @param screenerResourceId a <code>long</code> providing the ID for screener
   *                           resource.
   * @param submissionId       a <code>long</code> providing the ID for
   *                           submission.
   * @return a <code>ScorecardReviewData</code> providing the details for review
  ...
  public Submission[] getSoftwareProjectSubmissions(TCSubject currentUser, long projectId)
    ...
    Filter filter2 = SearchBundle
        .buildNotFilter(SubmissionFilterBuilder.createSubmissionStatusIdFilter(SUBMISSION_DELETE_STATUS_ID));
  ...
  /**
   * <p>
   * Gets the active submissions for specified project with the specified
   * submission type.
   * </p>
   *
   * @param projectId      a <code>long</code> providing the ID of a project.
   * @param submissionType a <code>int</code> providing the id of the submission
   *                       type.
   ...
   * </p>
   *
   * @param review a <code>Review</code> providing the details for review to be
   *               created.
   ...
   *
   * <p>
   * Updates in version 1.9.6 - Do the copilot and 2nd place pick up in one
   * transaction
   * </p>
   *
   * @param currentUser             a <code>TCSubject</code> representing the
   *                                current user.
   * @param tcDirectProjectId       a <code>long</code> providing the TC Direct
   *                                project ID.
   * @param copilotPostingProjectId a <code>long</code> providing the ID for
   *                                <code>Copilot Posting</code> contest.
   * @param winnerProfileId         a <code>long</code> providing the winner
   *                                copilot profile ID.
   * @param winnerSubmissionId      a <code>String</code> providing the winner
   *                                copilot submission ID.
   * @param secondPlaceSubmissionId a <code>String</code> providing the second
   *                                place copilot submission ID.
   *
   * @throws PermissionServiceException if current user is not allowed to perform
  ...
  public void selectCopilot(TCSubject currentUser, long tcDirectProjectId, long copilotPostingProjectId,
      long winnerProfileId, long winnerSubmissionId, long secondPlaceSubmissionId)
    ...
    try {
      ...
      // Find a review for specified resource and submission and if not exists then
      // create one
      ...
      if (winnerProfileId > 0) {
        ...
        if (userPermissionMaps.containsKey(tcDirectProjectId)
            && userPermissionMaps.get(tcDirectProjectId).containsKey(userId)) {
          // update permission
        ...
        permissionServiceFacade.updateProjectPermissions(currentUser, permissionsToAdd,
            ResourceRole.RESOURCE_ROLE_COPILOT_ID);
      ...
      /*
       * if (hasScreening(softwareCompetition)) { // Find the screener resource for
       * current user; if there is none then create one
       * com.topcoder.management.resource.Resource screener =
       * addPrimaryScreener(currentUser, copilotPostingProjectId,
       * currentUser.getUserId());
       * 
       * long screeningPhaseId = getScreening(softwareCompetition).getId();
       * 
       * // we will pass screening for all for (int i = 0; i < submissions.length;
       * i++) { Submission submission = submissions[i]; ScorecardReviewData
       * screeningData = getScreening(copilotPostingProjectId, screener.getId(),
       * submission.getId()); if ((screeningData.getReview() == null) ||
      ...
      com.topcoder.management.resource.Resource reviewer = addReviewer(currentUser, copilotPostingProjectId,
          currentUser.getUserId());
   ...
   * @param copilotProjects the copilot projects to update
   * @param removeFlags     whether to remove or add
   * @return updated copilot projects
   * @throws PermissionServiceException if current user has no permission to
   *                                    perform this operation
   * @throws ContestServiceException    if any exception occurs
   */
  public List<CopilotProject> updateCopilotProjects(TCSubject currentUser, List<CopilotProject> copilotProjects,
      List<Boolean> removeFlags) throws PermissionServiceException, ContestServiceException {
    // check permissions
    for (CopilotProject copilotProject : copilotProjects) {
      checkSoftwareProjectPermission(currentUser, copilotProject.getTcDirectProjectId(), false);
    }
      ...
      for (int i = 0; i < copilotProjects.size(); i++) {
        ...
        if (removeFlag) {
          ...
          if (userPermissionMaps.containsKey(copilotProject.getTcDirectProjectId())
              && userPermissionMaps.get(copilotProject.getTcDirectProjectId()).containsKey(userId)) {
            ProjectPermission permission = new ProjectPermission();
          ...
          if (!projectNames.containsKey(copilotProject.getTcDirectProjectId())) {
            projectNames.put(copilotProject.getTcDirectProjectId(),
                projectService.getProject(currentUser, copilotProject.getTcDirectProjectId()).getName());
   ...
   * @throws UserServiceException if any exception occurs when retrieving user
   *                              handle.
   * @throws CopilotDAOException  if any exception occurs when performing DB
   *                              operation.
   */
   ...
   * @param scorecard    a <code>Scorecard</code> providing the details for
   *                     scorecard.
   * @throws ReviewManagementException if an unexpected error occurs.
   */
  private void createReview(com.topcoder.management.resource.Resource reviewer, long submissionId, int placement,
      Scorecard scorecard, long projectPhaseId) throws ReviewManagementException {
   ...
   * @throws ReviewManagementException if an unexpected error occurs.
   */
  private void createScreening(com.topcoder.management.resource.Resource screener, long submissionId,
      Scorecard scorecard, long projectPhaseId) throws ReviewManagementException {
    Review review = new Review();
   ...
   * @throws PermissionServiceException if current user has no permission on it
   */
  private Map<Long, Map<Long, Long>> getUserPermissionMaps(TCSubject currentUser) throws PermissionServiceException {
    ...
    for (ProjectPermission permission : permissions) {
      if (!userPermissionMaps.containsKey(permission.getProjectId())) {
        userPermissionMaps.put(permission.getProjectId(), new HashMap<Long, Long>());
      }
      userPermissionMaps.get(permission.getProjectId()).put(permission.getUserId(), permission.getUserPermissionId());
    }

    return userPermissionMaps;
  }

  private Map<Integer, String> getUserPreferenceMaps(long userId, List<Integer> preferenceIds) throws Exception {
    Properties p = new Properties();
    p.put(Context.INITIAL_CONTEXT_FACTORY, "org.jnp.interfaces.NamingContextFactory");
    p.put(Context.URL_PKG_PREFIXES, "org.jboss.naming:org.jnp.interfaces");
    p.put(Context.PROVIDER_URL, userBeanProviderUrl);
  ...
  /**
   * <p>
   * Gets the client feedback of the specified studio submission. The client
   * feedback is the comment in the review board of the submission.
   * </p>
   *
   ...
   * @param phaseType    a <code>PhaseType</code> providing the phase type which
   *                     the submission belongs to.
   * @return a <code>String</code> providing the client feedback of the
   *         submission.
   * @throws ContestServiceException if any error occurs.
   * @since 1.6.9
   */
  public String getStudioSubmissionFeedback(TCSubject tcSubject, long projectId, long submissionId, PhaseType phaseType)
    ...
    // gets the reviewer resource, the user of reviewer resource must be current
    // user
  ...
  /**
   * <p>
   * save the rank and client feedback for a specified submission. The reviewer is
   * the current user. And the review board is assumed only have one question
   * rating from 1 to 10. The client feedback is the comment in the review board.
   * </p>
   *
   * @param tcSubject    a <code>TCSubject</code> representing the current user.
   * @param projectId    a <code>long</code> providing the ID of a project.
   * @param submissionId a <code>long</code> providing the ID of the submission.
   * @param placement    a <code>int</code> providing the placement of the
   *                     submission.
   * @param feedback     a <code>String</code> providing the client feedback of
   *                     the submission. Feedback will not changed if it is null.
   * @param committed    a <code>boolean</code> representing whether to commit the
   *                     review board.
   * @param phaseType    a <code>PhaseType</code> providing the phase type which
   *                     the submission belongs to.
   * @throws ContestServiceException if any error occurs.
  ...
  public void saveStudioSubmisionWithRankAndFeedback(TCSubject tcSubject, long projectId, long submissionId,
      int placement, String feedback, Boolean committed, PhaseType phaseType) throws ContestServiceException {
    ...
    try {
      ...
      // user
      com.topcoder.management.resource.Resource reviewerResource = null;
      com.topcoder.management.resource.Resource[] resources = projectServices.searchResources(projectId,
          resourceRoleId);
      ...
      if (contestData.getProjectHeader().getProjectCategory().getId() == ProjectCategory.DESIGN_FIRST2FINISH.getId()
      ...
      if (resources.length == 0) {
        ...
        for (com.topcoder.management.resource.Resource resource : projectServices.searchResources(projectId,
            resourceRoleId)) {
   ...
   *
   * @param currentUser a <code>TCSubject</code> representing the current user.
   * @param submissions a <code>List</code> providing the submissions to be
   *                    updated.
   * @throws ContestServiceException if any error occurs.
   * @since 1.6.9
   */
  public void updateSoftwareSubmissions(TCSubject currentUser, List<Submission> submissions)
      throws ContestServiceException {
    try {
  ...
  /**
   * <p>
   * Save the ranks and feedbacks for the checkpoint sumbissions of a contest. The
   * reviewer is the current user. And the review board is assumed only have one
   * question rating from 1 to 10. The feedback is the comment in the review
   * board.
   * </p>
   *
   * @param tcSubject       a <code>TCSubject</code> representing the current user
   * @param projectId       a <code>long</code> providing the ID of a contest
   * @param submissionIds   a <code>long</code> array providing the IDs of the
   *                        submissions
   * @param placements      a <code>int</code> array providing the placements of
   *                        the submissions
   * @param feedbacks       a <code>String</code> array providing the client
   *                        feedbacks of the submissions
   * @param committed       a <code>boolean</code> representing whether to commit
   *                        the review board
   * @param generalFeedback a <code>String</code> providing the general feedback
   *                        of the submissions
   * @throws ContestServiceException if any error occurs
   * @since 1.8.7
   */
  public void saveSoftwareCheckpointReviewWithRankAndFeedback(TCSubject tcSubject, long projectId, long[] submissionIds,
      int[] placements, String[] feedbacks, Boolean committed, String generalFeedback) throws ContestServiceException {
    try {
      ...
      for (int i = 0; i < submissionIds.length; ++i) {
        saveStudioSubmisionWithRankAndFeedback(tcSubject, projectId, submissionIds[i], placements[i], feedbacks[i],
            committed, PhaseType.CHECKPOINT_REVIEW_PHASE);
      }
      ...
      if (committed) {
        ...
        if (createForum) {
          jiveCategoryId = getSoftwareContestByProjectId(tcSubject, projectId).getAssetDTO().getForum()
              .getJiveCategoryId();
        }
        if (jiveCategoryId != null && jiveCategoryId > 0) {
          ...
          if (generalFeedback != null && generalFeedback.trim().length() > 0) {
            ...
            forums.postThreadToQuestionForum(jiveCategoryId, "General Checkpoint Feedback", generalFeedback,
                tcSubject.getUserId());
          }
          for (int i = 0; i < submissionIds.length; i++) {
            if (feedbacks[i] != null && feedbacks[i].trim().length() > 0) {
              forums.postThreadToQuestionForum(jiveCategoryId, "#" + submissionIds[i] + " Checkpoint Feedback",
                  feedbacks[i], tcSubject.getUserId());
            }
          }
        }
      }
   ...
   * @throws com.topcoder.management.review.application.ReviewAuctionManagerException if
   *                                                                                  fail
   *                                                                                  to
   *                                                                                  create
   *                                                                                  review
   *                                                                                  auction.
   * @throws ContestEligibilityPersistenceException                                   if
   *                                                                                  fail
   *                                                                                  to
   *                                                                                  get
   *                                                                                  contest
  ...
  private void addReviewAuction(SoftwareCompetition softwareCompetition)
    ...
    boolean hasEligibility = contestEligibilityManager
        .haveEligibility(new Long[] { softwareCompetition.getProjectHeader().getId() }, false).size() > 0;
    long billingProjectId = getBillingProjectId(softwareCompetition);

    // if creating contest, eligibility is not committed, so above will not get back
    // result
    if (billingProjectId != 0 && softwareCompetition.getProjectHeader().getSecurityGroupId() > 0) {
      hasEligibility = true;
    }
  ...
  /**
   * Check cca status of contest. If billing account must use cca while current
   * property not, the change it
   * 
   * @param contest the contest
  ...
  private boolean isPrivateProject(SoftwareCompetition contest) {
    return contest.getProjectHeader().getProperty(ProjectPropertyType.PRIVATE_PROJECT) != null
        && "1".equals(contest.getProjectHeader().getProperty(ProjectPropertyType.PRIVATE_PROJECT));
  }
  ...
  public void closeSoftwareContest(TCSubject tcSubject, long projectId, long winnerId) throws ContestServiceException {
    ...
    try {
          ...
          if (phase.getPhaseStatus().getId() == PhaseStatus.OPEN.getId()) {
            ...
            for (Submission submission : submissions) {
              if (submission.getPlacement() != null && submission.getPlacement() == 1L) {
                ...
                throw new ContestServiceException(
                    "Winner for this challenge has been selected or " + "challenge has been closed before");
              }
            }
          }
        }
      ...
      long roleId = contest.getProjectCategory().getId() == ProjectCategory.FIRST2FINISH.getId()
          ...
          : ResourceRole.RESOURCE_ROLE_REVIEWER_ID;
      ...
      // create review
      Scorecard scorecard = projectServices
          .getScorecard(Long.parseLong((String) reviewPhase.getAttribute(SCORECARD_ID_ATTRIBUTE)));
   ...
   * @since 3.9
   */
  private void processManualCopilotPayment(com.topcoder.management.resource.Resource[] resources, long projectId,
