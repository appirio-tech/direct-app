...
public class TestHelper {
     ...
     *
     * @return the domain for Selenium server.
     * @throws Exception if any error occurred.
     * @since 1.1
     */
    ...
    static void clearProject()
    	...
    	try {
    		con = getConnection();
    		PreparedStatement ps = con.prepareStatement("DELETE FROM tc_direct_project WHERE name = 'test';");
    		ps.executeUpdate();
    	} finally {
    		if (con != null) {
    			con.close();
