...
$(document).ready(function(){
	...
	/*$('.stepFirst .geryContent .nextStepButton').click(function(){
		if($('.stepFirst .text').val() == "" || $('.stepFirst textarea').val() == ""){
			addresscloseModal();
			addressLoadModal('#errortModal');
		}else{
			window.location.href = 'start-a-new-project-step-2.html';	
		}
	});*/
	...
	$('.stepSecond .geryContent .nextStepButton').click(function(){
		...
		if(!falgRadio){
			...
			if($('.stepSecond .radio:checked').parent().find('label').text() == 'Custom'){
				window.location.href = 'start-a-new-project-step-3-custom.html';	
			}else{
	...
	*/
	...
	$('.stepSecond .geryContent .detailButton').click(function(){
		...
		$('#detailModal h2').text($(this).parent().parent().parent().parent().parent().parent().find('.radioBox label').text());
	});
	
	$('.stepSecond .geryContent .gamePlanButton').click(function(){
		addresscloseModal();
		addressLoadModal('#gamePlanModal');
		recreateChartControl('ganttChartDiv', true);
		$('#gamePlanModal h2').text('Game Plan for ' + $(this).parent().parent().parent().parent().parent().parent().find('.radioBox label').text() +' - Medium');
	});*/
	...
	$('.stepForth .geryContent .nextStepButton').click(function(){
		...
		if(!falgRadio1){
			...
			window.location.href = 'start-a-new-project-step-5.html';	
		}
	});*/
