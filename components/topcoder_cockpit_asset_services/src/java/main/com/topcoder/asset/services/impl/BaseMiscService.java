 ...
 * JPA EntityManager to be used by subclasses. It also holds Logging Wrapper logger to be used by subclasses for
 * logging errors and debug information. It's assumed that subclasses will be initialized with Spring setter
 ...
 * @version 1.1
 */
public abstract class BaseMiscService {
    /**
     * The EntityManager instance to be used by subclasses for accessing JPA entities in persistence. Initialized with
     ...
     * checkInit() method instead of the setter). Has a setter and a protected getter.
     */
     ...
     * setLog() method. If it is null, logging is not performed. Has a setter and a protected getter.
     */
    private Log log;

    /**
     * Creates an instance of BaseMiscService.
     */
    protected BaseMiscService() {
        // Empty
    }
     ...
     *
     * @param log
     *            the logger to be used by subclasses for logging errors and debug information.
     */
