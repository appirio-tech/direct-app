...
insert into audit_action_type_lu (audit_action_type_id, name, description, create_user, create_date, modify_user, modify_date) values (1, 'Create', 'Create', '156859', TO_DATE('2010-03-02 09:44:56', '%Y-%m-%d %H:%M:%S'), '156859', TO_DATE('2010-03-02 09:44:56', '%Y-%m-%d %H:%M:%S'));
insert into audit_action_type_lu (audit_action_type_id, name, description, create_user, create_date, modify_user, modify_date) values (2, 'Delete', 'Delete', '156859', TO_DATE('2010-03-02 09:44:56', '%Y-%m-%d %H:%M:%S'), '156859', TO_DATE('2010-03-02 09:44:56', '%Y-%m-%d %H:%M:%S'));
insert into audit_action_type_lu (audit_action_type_id, name, description, create_user, create_date, modify_user, modify_date) values (3, 'Update', 'Update', '156859', TO_DATE('2010-03-02 09:44:56', '%Y-%m-%d %H:%M:%S'), '156859', TO_DATE('2010-03-02 09:44:56', '%Y-%m-%d %H:%M:%S'));
