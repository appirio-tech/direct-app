...
/**
 * <p>
 * A helper class to perform those common operations which are helpful for the new test in version
 * 1.1.
 * </p>
 *
 * @author TCSDEVELOPER
...
public final class TestHelper {
    ...
    /**
     * <p>
     * Static code block to initialize those constants from "test_files\testconfig.xml" using
     * Configuration API.
     * </p>
     */
    static {
    ...
    /**
     * <p>
     * Helper method to get the instance of DBConnectionFactory for testing use. If the inner
     * factory is null, a new instance would be initialized.
     * </p>
     *
    ...
    /**
     * <p>
     * Helper method to initialize the database for test use. It create a database with the name
     * "tcmodule", create some tables, and add some entries using the sql script.
     * </p>
     *
     * @throws Exception to JUnit
     */
    public static void initializeDB() throws Exception {
        ...
        if (createtablesql == null) {
            ...
            for (int i = 0; i < tableName.length; ++i) {
                createtablesql[i] = getSQLScript("test_files" + File.separator + "sqlscript"
                    + File.separator + tableName[i] + ".sql");
            }
        }
     ...
     * <p>
     * Helper method to initialize the database for test use. It create a database with the name
     * "tcmodule", create the requred table tables. No entries would be added.
     * </p>
     *
     * @throws Exception to JUnit
     */
    public static void initializeDBWithNoEntry() throws Exception {
        ...
        if (createtablesql == null) {
            ...
            createtablesql = new String[tableName.length];
            for (int i = 0; i < tableName.length; ++i) {
                createtablesql[i] = getSQLScript("test_files" + File.separator
                    + "sqlscript" + File.separator +  tableName[i] + ".sql");
            }
        }
