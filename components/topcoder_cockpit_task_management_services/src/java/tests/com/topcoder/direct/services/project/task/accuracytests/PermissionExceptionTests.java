...
/**
 * <p>Unit tests for {@link PermissionException} class.</p>
 *
 * @author gjw99
 * @version 1.0
 */
public class PermissionExceptionTests extends TestCase {
    /**
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(PermissionExceptionTests.class);
    }
    ...
    public void testInheritence() {
        assertEquals("inheritance is wrong", TaskManagementException.class, PermissionException.class.getSuperclass());
    }
    ...
    public void testCtor1() {
        exception = new PermissionException(MESSAGE);
    ...
    public void testCtor2() {
        exception = new PermissionException(MESSAGE, CAUSE);
        assertNotNull("message is not set", exception.getMessage());
        assertEquals("message is not set", MESSAGE, exception.getMessage());
